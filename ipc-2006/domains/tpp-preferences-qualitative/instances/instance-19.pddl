...
(:constraints (and
	...
	(forall (?l - level) (preference p9A
	   (sometime-before (and (not (= ?l level0)) (stored goods2 ?l))
			    (stored goods12 ?l))))
	(forall (?l - level) (preference p9B
	   (sometime-before (and (not (= ?l level0)) (stored goods16 ?l))
			    (stored goods18 ?l))))
	(forall (?l - level) (preference p9C
	   (sometime-before (and (not (= ?l level0)) (stored goods2 ?l))
			    (stored goods13 ?l))))
	(forall (?l - level) (preference p9D
	   (sometime-before (and (not (= ?l level0)) (stored goods12 ?l))
			    (stored goods19 ?l))))
	(forall (?l - level) (preference p9E
	   (sometime-before (and (not (= ?l level0)) (stored goods7 ?l))
			    (stored goods10 ?l))))
	(forall (?l - level) (preference p9F
	   (sometime-before (and (not (= ?l level0)) (stored goods9 ?l))
			    (stored goods19 ?l))))))
