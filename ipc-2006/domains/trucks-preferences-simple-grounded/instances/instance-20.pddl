...
(:goal (and        
(at-destination_package20_l2)        
(at-destination_package19_l2)        
(at-destination_package18_l2)        
(at-destination_package17_l5)        
(at-destination_package16_l5)        
...
(at-destination_package1_l1)
        (preference P1P 
            (delivered_package19_l2_t25))
        (preference P1O 
            (delivered_package18_l2_t25))
        (preference P1N 
            (delivered_package17_l5_t25))
        (preference P1M 
            (delivered_package16_l5_t20))
        (preference P1L 
            (delivered_package15_l4_t20))
        (preference P1K 
...
(:constraints (and))
(:metric MINIMIZE  (+  (* 1.000000 (IS-VIOLATED P1A))  (+  (* 1.000000 (IS-VIOLATED P1B))  (+  (* 1.000000 (IS-VIOLATED P1C))  (+  (* 1.000000 (IS-VIOLATED P1D))  (+  (* 1.000000 (IS-VIOLATED P1E))  (+  (* 1.000000 (IS-VIOLATED P1F))  (+  (* 1.000000 (IS-VIOLATED P1G))  (+  (* 1.000000 (IS-VIOLATED P1H))  (+  (* 1.000000 (IS-VIOLATED P1I))  (+  (* 1.000000 (IS-VIOLATED P1J))  (+  (* 1.000000 (IS-VIOLATED P1K))  (+  (* 1.000000 (IS-VIOLATED P1L))  (+  (* 1.000000 (IS-VIOLATED P1M))  (+  (* 1.000000 (IS-VIOLATED P1N))  (+  (* 1.000000 (IS-VIOLATED P1O))  (* 1.000000 (IS-VIOLATED P1P))))))))))))))))))
)