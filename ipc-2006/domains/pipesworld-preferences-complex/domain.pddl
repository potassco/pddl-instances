; IPC5 Domain: Pipesworld ComplexPreferences (extension of the Pipesworld IPC4 domain)
; Author: Patrik Haslum

(define (domain pipesworld_strips)
  (:requirements :strips :typing :durative-actions :fluents :equality :constraints :preferences)
  ...
  (:durative-action PUSH-START
    :parameters(
     ...
     ?pipe - pipe
     ;; Unitary batch that will be inserted into the pipeline segment
