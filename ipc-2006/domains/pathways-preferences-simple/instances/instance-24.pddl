...
(:goal
	(and
	(preference p0A (or (available p27p1-cdk46-cycDp1) (available cdk46p2-cycD)))
	(preference p0B (or (available p27p1-cdk46p2-cycDp1) (available p21-cdk46p2-cycD)))
	(preference p0C (or (available p57-cdk46p2-cycDp1) (available PCNA-p21-cdk46-cycD)))
	(preference p0D (or (available p21-cdk46-cycD) (available p21-cdk46-cycDp1)))
	(preference p0E (or (available PCNA-p21-cdk46p2-cycDp1) (available p57p1-cdk46-cycDp1)))
	(preference p0F (or (available p57-cdk46p2-cycD) (available p57p1-cdk46p2-cycDp1)))
	(preference p0G (or (available cdk46-cycDp1) (available cdk46p2-cycDp1)))
	(preference p0H (or (available HDAC1-p107-E2F4-DP12p1) (available p57p1-cdk46-cycD)))
	(preference p0I (or (available SP1-E2F13p1-gP) (available p57-cdk46-cycD)))
	(preference p0J (or (available Skp2-Skp1p1-cdk2-cycA) (available Ecadherin)))
	(preference p0K (or (available pRbp1p2-Jun-c-Fos) (available p27-cdk46p2-cycD)))
	(preference p0L (or (available PCNA-p21-cdk2p1p2-cycA) (available cdk46p2)))
	(preference p0M (or (available cdk46-cycD) (available p27-cdk46-cycD)))
	(preference p0N (or (available PCNA-p21-cdk46-cycDp1) (available p27-cdk46p2-cycDp1)))
	(preference p0O (or (available p27-cdk2p1p2-cycA) (available cdk46)))
	(preference p0P (or (available HDAC1-p107-E2F4-DP12) (available p27-cdk46p1-cycD)))
	(preference p0Q (or (available SP1-p107-gP) (available PCNA-p21-cdk46p2-cycD)))
	(preference p0R (or (available Raf1-cdc25Ap1) (available p21-cdk2-cycE)))
	(preference p0S (or (available Raf1-cdc25A) (available p27p1-cdk2p1-cycE)))
	(preference p0T (or (available p27p1-cdk46p2-cycD) (available p57p1-cdk46p2-cycD)))
	(preference p0U (or (available p27p1-cdk46p1p2-cycDp1) (available Skp2-Skp1p1-cdk2p2-cycA)))
	(preference p0V (or (available p27-cdk46-cycDp1) (available p21-cdk46p2-cycDp1)))
	(preference p0W (or (available Skp2-Skp1p1-cdk2p1p2-cycA) (available p57-cdk46-cycDp1)))
	(preference p0X (or (available p27p1-cdk2p1p2-cycE) (available p27p1-cdk46-cycD)))
	(preference p0Y (or (available Skp2-Skp1p1-cdk2p1-cycA) (available cdc25Ap1)))
	(preference p0Z (or (available cdk2-cycA-E2F13p1) (available p27p1-cdk2p1-cycEp1)))
	(preference p0AB (or (available p27p1-cdk2-cycE) (available PCNA-p21-cdk2-cycEp1)))
	(preference p0BB (or (available cdk2p1p2-cycA-E2F13) (available pRbp1-E2F13-DP12)))
	(preference p0CB (or (available p27p1-cdk2-cycEp1) (available p27p1-cdk46p1-cycDp1)))
	(preference p0DB (or (available Skp2-Skp1-cdk2p2-cycA) (available p27p1-cdk2p1p2-cycA)))
	(preference p0EB (or (available cdk2p2-cycA-E2F13p1) (available cdk2p1p2)))
...
(:metric minimize (+ (* 1.0 (is-violated p0A))
		     (* 1.0 (is-violated p0B))
		     (* 1.0 (is-violated p0C))
		     (* 1.0 (is-violated p0D))
		     (* 1.1 (is-violated p0E))
