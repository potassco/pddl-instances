...
(:goal
	(and
	(preference p0A (or (available Skp2-Skp1p1-cdk2-cycA) (available Mdm2-pRbp2)))
	(preference p0B (or (available Raf1-pRbp1-E2F4-DP12-gE2) (available p27p1-cdk2p2-cycEp1)))
	(preference p0C (or (available Skp2-Skp1p1-cdk2p2-cycA) (available Skp2-Skp1p1-cdk2p1-cycA)))
	(preference p0D (or (available Skp2-Skp1p1-cdk2p1p2-cycA) (available p27p1-cdk46p1-cycD)))
	(preference p0E (or (available cdk1p3-cycA) (available cycD)))
	(preference p0F (or (available p27-cdk2p2-cycA) (available p27-cdk2p2-cycE)))
	(preference p0G (or (available cdk2p2-cycE) (available p27p1-cdk2p2-cycA)))
	(preference p0H (or (available cdk2p2-cycA-E2F13p1) (available p21-cdk46p2-cycD)))
	(preference p0I (or (available p27p1-cdk46p1p2-cycDp1) (available p27p1-cdk2p1p2-cycE)))
	(preference p0J (or (available p21-cdk2-cycA) (available Wee1p1)))
	(preference p0K (or (available cdk46p1p2) (available p68p2)))
	(preference p0L (or (available p21-cdk2-cycE) (available cdk2-cycA-E2F13)))
	(preference p0M (or (available cdk46-cycDp1) (available p27p1-cdk46p1p2-cycD)))
	(preference p0N (or (available p27-cdk46p2-cycDp1) (available pRbp1-E2F13p1-DP12)))
	(preference p0O (or (available Skp1p1) (available p27p1-cdk46p1-cycDp1)))
	(preference p0P (or (available p21-cdk46-cycD) (available p21-cdk46-cycDp1)))
	(preference p0Q (or (available p16-cdk46p2) (available Raf1-pRb-E2F13p1-DP12)))
	(preference p0R (or (available p27p1-cdk2p1-cycE) (available p27p1-cdk2p1-cycA)))
	(preference p0S (or (available p27p1-cdk2-cycEp1) (available pRbp1-Jun-c-Fos)))
	(preference p0T (or (available p68p1p2) (available cdk2p2-cycA-E2F13)))
	(preference p0U (or (available Skp2-Skp1-cdk2p2-cycA) (available Skp2p1)))
