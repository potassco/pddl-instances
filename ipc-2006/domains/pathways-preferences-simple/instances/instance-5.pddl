...
(:goal
	(and
	(preference p0A (or (available cycE) (available PCNA-p21-cdk2p1-cycEp1)))
	(preference p0B (or (available SP1-p107) (available p21-cdk2p1-cycEp1)))
	(preference p0C (or (available PCNA-p21-cdk2-cycE) (available cdk1p1p2-Gadd45)))
	(preference p0D (or (available PCNA-p21) (available p130-E2F5-DP12p1-gE2)))
	(preference p0E (or (available SP1-p107p1) (available PCNA-p21-cdk2p1-cycE)))
	(preference p0F (or (available E2F5-DP12-gE2) (available c-Myc)))
...
(:metric minimize (+ (* 2.0 (is-violated p0A))
		     (* 1.3 (is-violated p0B))
		     (* 2.0 (is-violated p0C))
		     (* 1.5 (is-violated p0D))
		     (* 1.7 (is-violated p0E))
