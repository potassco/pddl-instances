...
(:goal
	(and
	(preference p0A (or (available p16-cdk46) (available Raf1-cdc25Ap1)))
	(preference p0B (or (available p21-cdk46-cycDp1) (available PCNA-p21-cdk46-cycD)))
	(preference p0C (or (available p16-cdk46p2) (available c-Myc-AP2)))
	(preference p0D (or (available p57-cdk46-cycD) (available cdk46-cycD)))
	(preference p0E (or (available p21-cdk46-cycD) (available p57p1-cdk46-cycDp1)))
	(preference p0F (or (available pRbp1p2-AP2) (available p57p1-cdk46p2-cycD)))
	(preference p0G (or (available cdk46-cycDp1) (available p57p1-cdk46-cycD)))
	(preference p0H (or (available cdk46p2-cycDp1) (available E2F4-DP12-gE2)))
	(preference p0I (or (available cdk46p2-cycD) (available PCNA-p21-cdk46p2-cycDp1)))
	(preference p0J (or (available p57-cdk46p2-cycDp1) (available p21-cdk46p2-cycD)))
	(preference p0K (or (available cdk1p3-Gadd45) (available cdk46p2)))
	(preference p0L (or (available p57-cdk46p2-cycD) (available PCNA-p21-cdk46-cycDp1)))
	(preference p0M (or (available Mdm2-E2F13p1-DP12p1) (available PCNA-p21-cdk46p2-cycD)))
	(preference p0N (or (available p57-cdk46-cycDp1) (available p21-cdk46p2-cycDp1)))
	(preference p0O (or (available p57p1-cdk46p2-cycDp1) (available cdk1p2)))
	(preference p0P (or (available cdk46) (available SP1-E2F13p1-gP)))
	(preference p0Q (or (available Wee1p1) (available Raf1-cdc25A)))
	(preference p0R (or (available Skp2-Skp1p1-cdk2p1p2-cycA) (available Skp2-Skp1p1-cdk2-cycA)))
	(preference p0S (or (available CEBP-pRbp1p2) (available cdk1p3-cycB)))
	(preference p0T (or (available cdk1p3-cks1) (available p53-DP12p1)))
	(preference p0U (or (available cdk2p1p2-cycA-E2F13p1) (available Skp2-Skp1p1-cdk2p1-cycA)))
	(preference p0V (or (available Skp2-Skp1p1-cdk2p2-cycA) (available cdk1p3-cycA)))
	(preference p0W (or (available p53p1-DP12p1) (available PCNA-p21-cdk2p1p2-cycE)))
	(preference p0X (or (available HDAC1-p130-E2F4-DP12) (available cdc25Ap1)))
	(preference p0Y (or (available SL1p1) (available cycD)))
	(preference p0Z (or (available cdk2p2-cycA-E2F13p1) (available p68p1p2)))
	(preference p0AB (or (available cdk2-cycA-E2F13p1) (available Raf1-p130-E2F4-DP12-gE2)))
	(preference p0BB (or (available cdc25A) (available SP1-p107)))
	(preference p0CB (or (available SP1-E2F13p1) (available Skp2p1-Skp1p1)))
	(preference p0DB (or (available Skp2-Skp1p1) (available Mdm2-E2F13p1-DP12)))
	(preference p0EB (or (available cdk2p1-cycA-E2F13p1) (available Skp2p1-Skp1)))
	(preference p0FB (or (available HDAC1-p107-E2F4-DP12-gE2) (available cdk1p1p2-Gadd45)))
	(preference p0GB (or (available Ecadherin) (available Skp2p1)))
...
(:metric minimize (+ (* 1.1 (is-violated p0A))
		     ...
		     (* 1.1 (is-violated p0Y))
		     (* 1.2 (is-violated p0Z))
		     (* 1.2 (is-violated p0AB))
		     (* 1.1 (is-violated p0BB))
		     (* 1.1 (is-violated p0CB))
		     (* 1.2 (is-violated p0DB))
		     (* 1.2 (is-violated p0EB))
