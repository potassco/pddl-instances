...
(:goal
	(and
	(preference p0A (or (available HDAC1-p107-E2F4-DP12-gE2) (available pRbp1-E2F4-DP12-gE2)))
	(preference p0B (or (available p107-E2F4-DP12p1-gE2) (available Raf1-p130-E2F5-DP12-gE2)))
	(preference p0C (or (available p21-cdk2-cycE) (available pRbp1-E2F13-DP12)))
	(preference p0D (or (available p57-cdk2p1-cycE) (available cdk1)))
	(preference p0E (or (available cdk2p1-cycA) (available HDAC1-pRb-E2F13p1-DP12-gE2)))
	(preference p0F (or (available SP1-p107-gP) (available p130-E2F4-DP12)))
	(preference p0G (or (available PCNA-cycD) (available p57-cdk46p1-cycD)))
	(preference p0H (or (available p57-cdk2p1-cycEp1) (available p27-cdk2p1-cycE)))
	(preference p0I (or (available p21-cdk46p1-cycDp1) (available HDAC1-p107-E2F4-DP12)))
	(preference p0J (or (available p27-cdk2p1-cycEp1) (available DMP1-cycD)))
	(preference p0K (or (available PCNA-p21-cdk2p1-cycEp1) (available cdk1-Gadd45)))
	(preference p0L (or (available Skp2-Skp1-cdk2-cycA) (available SP1-p107)))
	(preference p0M (or (available Skp2-cdk2-cycA) (available PCNA-Gadd45)))
	(preference p0N (or (available HDAC1-p130-E2F4-DP12-gE2) (available p130-E2F4-DP12-gE2)))
	(preference p0O (or (available Raf1-pRbp1-E2F4-DP12-gE2) (available Raf1-pRbp1-E2F13-DP12-gE2)))
	(preference p0P (or (available HDAC1-p130-E2F5-DP12) (available Raf1-p130-E2F4-DP12)))
	(preference p0Q (or (available cdk2-cycA) (available p27-cdk2-cycE)))
	(preference p0R (or (available PCNA-p21-cdk46p1-cycDp1) (available CEBP-pRbp2-gP)))
	(preference p0S (or (available p27-cdk2-cycEp1) (available PCNA-p21-cdk2-cycA)))
	(preference p0T (or (available Raf1-p130-E2F4-DP12-gE2) (available Raf1-pRbp1-E2F4-DP12)))
	(preference p0U (or (available p21-cdk2-cycA) (available Raf1-pRbp1-E2F13p1-DP12-gE2)))
	(preference p0V (or (available p57-cdk2p1-cycA) (available cdk2-cycE)))
	(preference p0W (or (available PCNA-p21-cdk2-cycEp1) (available p57-cdk2-cycEp1)))
	(preference p0X (or (available p21-cdk2p1-cycE) (available HDAC1-p107-E2F4-DP12p1)))
	(preference p0Y (or (available HDAC1-p130-E2F5-DP12-gE2) (available pRbp1-E2F13-DP12-gE2)))
	(preference p0Z (or (available p57p1-cdk46p1-cycD) (available Raf1-pRb-E2F13-DP12-gE2)))
	(preference p0AB (or (available CEBP-pRbp1-gP) (available Raf1-pRb-E2F13-DP12)))
	(preference p0BB (or (available p27-cdk2-cycA) (available p21-cdk46p1-cycD)))
	(preference p0CB (or (available PCNA-p21-cdk2p1-cycA) (available p27-cdk46p1-cycDp1)))
	(preference p0DB (or (available p57-cdk2-cycE) (available Skp2-cdk2p1-cycA)))
