...
(:goal
	(and
	(preference p0A (or (available p27-cdk46-cycD) (available Skp2-Skp1p1-cdk2p2-cycA)))
	(preference p0B (or (available Skp2-Skp1p1-cdk2p1p2-cycA) (available Skp2-Skp1p1-cdk2p1-cycA)))
	(preference p0C (or (available Skp2-Skp1p1-cdk2-cycA) (available SP1-E2F13p1-gP)))
	(preference p0D (or (available Raf1-cdc25A) (available p27p1-cdk2p1-cycA)))
	(preference p0E (or (available p57-cdk46-cycD) (available P)))
	(preference p0F (or (available cdk46p2-cycDp1) (available p57-cdk2p2-cycA)))
	(preference p0G (or (available p27p1-cdk2p1p2-cycA) (available p27p1-cdk46-cycD)))
	(preference p0H (or (available Skp2-cdk2-cycA) (available PCNA-p21-cdk2-cycEp1)))
	(preference p0I (or (available p21-cdk2p2-cycA) (available cdk2p1-cycA-E2F13p1)))
	(preference p0J (or (available p57-cdk2p2-cycEp1) (available p107-E2F4-DP12p1)))
	(preference p0K (or (available p27p1-cdk2p1-cycE) (available p27p1-cdk2-cycA)))
	(preference p0L (or (available HDAC1-p107-E2F4-DP12-gE2) (available p27p1-cdk46p2-cycD)))
	(preference p0M (or (available PCNA-p21-cdk46-cycDp1) (available cdc25Ap1)))
	(preference p0N (or (available Skp2-Skp1-cdk2p2-cycA) (available Skp2-cdk2p2-cycA)))
	(preference p0O (or (available p27-cdk2p2-cycE) (available p27p1-cdk2p1p2-cycE)))
	(preference p0P (or (available p57-cdk46p2-cycDp1) (available E2F13p1)))
	(preference p0Q (or (available p27-cdk46p2-cycD) (available p53p1-DP12p1)))
	(preference p0R (or (available p130-E2F4-DP12-gE2) (available p27p1-cdk46p1-cycDp1)))
	(preference p0S (or (available PCNA-p21) (available p21-cdk46p2-cycDp1)))
	(preference p0T (or (available p27p1-cdk46-cycDp1) (available PCNA-p21-cdk46p2-cycDp1)))
	(preference p0U (or (available p57p1-cdk46p2-cycDp1) (available CEBP-pRbp1p2)))
	(preference p0V (or (available cdk2-cycA-E2F13p1) (available p68p2)))
	(preference p0W (or (available p21-cdk46p2-cycD) (available PCNA-p21-cdk46p2-cycD)))
	(preference p0X (or (available cycA) (available HDAC1-p130-E2F4-DP12-gE2)))
	(preference p0Y (or (available cdk2p1p2-cycE) (available p21-cdk46-cycDp1)))
	(preference p0Z (or (available p27p1-cdk2p2-cycEp1) (available PCNA-p21-cdk2p2-cycE)))
	(preference p0AB (or (available p21-cdk2p1-cycE) (available p16-cdk46)))
	(preference p0BB (or (available p53-DP12p1) (available p27p1-cdk46p2-cycDp1)))
	(preference p0CB (or (available p57p1-cdk46-cycD) (available p27p1-cdk2p1-cycEp1)))
	(preference p0DB (or (available PCNA-p21-cdk46-cycD) (available p21-cdk2p2-cycEp1)))
	(preference p0EB (or (available p27p1-cdk2p1p2-cycEp1) (available p27p1-cdk2p2-cycE)))
	(preference p0FB (or (available cdc25A) (available p27p1-cdk2-cycE)))
	(preference p0GB (or (available p21-Gadd45) (available cdk2p2-cycA-E2F13p1)))
	(preference p0HB (or (available Skp2-Skp1p1) (available p27-cdk2p2-cycEp1)))
	(preference p0IB (or (available pRbp1-AP2-gE-c) (available Skp2p1-Skp1)))
...
(:metric minimize (+ (* 0.9 (is-violated p0A))
		     ...
		     (* 0.9 (is-violated p0BB))
		     (* 0.9 (is-violated p0CB))
		     (* 1.0 (is-violated p0DB))
		     (* 0.9 (is-violated p0EB))
		     (* 1.0 (is-violated p0FB))
		     (* 1.0 (is-violated p0GB))
		     (* 1.0 (is-violated p0HB))
		     (* 0.9 (is-violated p0IB))
		     (* 1 (is-violated p1A))
		     (* 2 (is-violated p2A))
		     (* 3 (is-violated p3A))
		     (* 4 (is-violated p4A))
