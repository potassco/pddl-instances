...
(:goal
	(and
	(preference p0A (or (available cdk1p3-cycB) (available SL1p1)))
	(preference p0B (or (available Wee1p1) (available cdk1p3-Gadd45)))
	(preference p0C (or (available cdk1p3-cks1) (available cdk1p1p3-Gadd45)))
	(preference p0D (or (available cdk1p1-cks1) (available cdk1p1p3-cks1)))
	(preference p0E (or (available cdk1-cks1) (available cdk1p1p3-cycB)))
	(preference p0F (or (available cdk1p1p2p3-cycB) (available Raf1-p130-E2F5-DP12)))
	(preference p0G (or (available cdk1p2p3-cycB) (available cdk1p2p3)))
	(preference p0H (or (available cdk1p3) (available cdk2p2-cks1)))
	(preference p0I (or (available cdk1p1p2p3-Gadd45) (available Raf1-pRbp1-E2F13-DP12)))
	(preference p0J (or (available cdk1p2p3-cks1) (available cdk1p2p3-Gadd45)))
	(preference p0K (or (available cdk1-Gadd45) (available pRbp1p2-Jun-c-Fos)))
	(preference p0L (or (available cdk1p2-cks1) (available cdk1)))
	(preference p0M (or (available CEBP-pRbp1) (available p16-cdk7p1)))
