...
(:goal
	(and
	(preference p0A (or (available cdk2-cycEp1) (available Skp2-cdk2-cycA)))
	(preference p0B (or (available p21-cdk2-cycEp1) (available Skp2-Skp1-cdk2-cycA)))
	(preference p0C (or (available Raf1-cdc25Ap1) (available PCNA-p21-cdk2-cycA)))
	(preference p0D (or (available cdk2-cycA-E2F13) (available p57-cdk2-cycE)))
	(preference p0E (or (available p107-E2F4-DP12p1) (available pRb-E2F13p1-DP12-gE2)))
	(preference p0F (or (available p57-cdk2-cycA) (available cdk2-cycE)))
	(preference p0G (or (available p21-cdk2-cycA) (available p57-cdk2-cycEp1)))
	(preference p0H (or (available p21-cdk2-cycE) (available PCNA-p21-cdk2-cycEp1)))
	(preference p0I (or (available cdk2-cycA) (available PCNA-p21-cdk2-cycE)))
	(preference p0J (or (available Raf1-cdc25A) (available cdc25A)))
	(preference p0K (or (available cdc25Ap1) (available cdk1-Gadd45)))
	(preference p0L (or (available c-Myc-Max-gcdc25A) (available Ecadherin)))
	(preference p0M (or (available Raf1-p130-E2F4-DP12-gE2) (available Raf1-pRbp1-E2F13p1-DP12p1-gE2)))
	(preference p0N (or (available PCNA-Gadd45) (available pRbp1-E2F13-DP12)))
	(preference p0O (or (available Skp2-Skp1-cdk2p1-cycA) (available Raf1-pRbp1-E2F13p1-DP12-gE2)))
	(preference p0P (or (available p21-cdk2p1-cycA) (available cdk1-cks1)))
	(preference p0Q (or (available p57-cdk2p1-cycA) (available pRbp1-E2F13p1-DP12p1-gE2)))
	(preference p0R (or (available Raf1-pRb-E2F13p1-DP12-gE2) (available c-Myc-Max)))
	(preference p0S (or (available cdk1p1-cks1) (available PCNA-p21-cdk2p1-cycE)))
	(preference p0T (or (available cycEp1) (available p21-cdk2p1-cycEp1)))
	(preference p0U (or (available p57-cdk2p1-cycEp1) (available pRb-E2F4-DP12-gE2)))
	(preference p0V (or (available Mdm2-pRbp1p2) (available DMP1-cycD)))
	(preference p0W (or (available cdk2p1-cycEp1) (available pRbp1-E2F13-DP12-gE2)))
	(preference p0X (or (available Raf1-pRbp1-E2F13-DP12p1-gE2) (available cdk2p1-cycA-E2F13)))
	(preference p0Y (or (available pRbp1-E2F13-DP12p1-gE2) (available Raf1-pRb-E2F4-DP12-gE2)))
	(preference p0Z (or (available p107-E2F4-DP12p1-gE2) (available Raf1-pRbp1-E2F4-DP12-gE2)))
	(preference p0AB (or (available p21-cdk2p1-cycE) (available p107-E2F4-DP12)))
	(preference p0BB (or (available pRbp1-E2F13-DP12p1) (available cdk1p1-Gadd45)))
	(preference p0CB (or (available c-Myc-AP2) (available Raf1-pRbp1-E2F13-DP12-gE2)))
