...
(:goal
	(and
	(preference p0A (or (available Skp2-cdk2p1-cycA) (available p57-cdk2p1-cycE)))
	(preference p0B (or (available SP1-p107-gP) (available p57p1-cdk46p1-cycDp1)))
	(preference p0C (or (available p57-cdk2p1-cycA) (available Raf1-pRbp1-E2F13-DP12p1)))
	(preference p0D (or (available Raf1-pRbp1-E2F4-DP12) (available HDAC1-p107-E2F4-DP12)))
	(preference p0E (or (available p57-cdk46p1-cycD) (available p57p1-cdk46p1-cycD)))
	(preference p0F (or (available cdk2p1-cycE) (available cdk2p1-cycA)))
	(preference p0G (or (available p57-cdk46p1-cycDp1) (available SP1-p107p1-gP)))
	(preference p0H (or (available p57-cdk2p1-cycEp1) (available RPA-cycA)))
...
(:metric minimize (+ (* 1.9 (is-violated p0A))
		     (* 1.6 (is-violated p0B))
		     (* 1.6 (is-violated p0C))
		     (* 1.4 (is-violated p0D))
		     (* 1.6 (is-violated p0E))
