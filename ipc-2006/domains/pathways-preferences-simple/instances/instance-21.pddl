...
(:goal
	(and
	(preference p0A (or (available p57p1-cdk46p2-cycD) (available PCNA-p21-cdk46p2-cycD)))
	(preference p0B (or (available cdk46-cycD) (available cdk46p2-cycDp1)))
	(preference p0C (or (available p16-cdk46) (available PCNA-p21-cdk46p2-cycDp1)))
	(preference p0D (or (available p57p1-cdk46-cycD) (available cdk46p2)))
	(preference p0E (or (available cdk46p1p2) (available pRbp1p2-Jun-c-Fos-gERCC1)))
	(preference p0F (or (available Skp2-cdk2-cycA) (available p16-cdk46p2)))
	(preference p0G (or (available PCNA-p21-cdk46-cycDp1) (available p57p1-cdk46p2-cycDp1)))
	(preference p0H (or (available p57-cdk46-cycDp1) (available p21-cdk46p2-cycD)))
	(preference p0I (or (available p21-cdk46-cycDp1) (available p57-cdk46p2-cycDp1)))
	(preference p0J (or (available cdk46-cycDp1) (available cdk46p2-cycD)))
	(preference p0K (or (available PCNA-p21-cdk46-cycD) (available p21-cdk46p2-cycDp1)))
	(preference p0L (or (available p57p1-cdk46-cycDp1) (available p57-cdk46-cycD)))
	(preference p0M (or (available p107-E2F4-DP12p1-gE2) (available cdk46)))
	(preference p0N (or (available p21-cdk46-cycD) (available pRbp1p2-Jun-c-Fos)))
	(preference p0O (or (available Raf1-cdc25Ap1) (available pRbp1-E2F13p1-DP12-gE2)))
	(preference p0P (or (available p57-cdk46p2-cycD) (available pRbp1p2-AP2-gE-c)))
	(preference p0Q (or (available Skp2-Skp1p1-cdk2p2-cycA) (available cdk2p1-cycA-E2F13p1)))
	(preference p0R (or (available Skp2-Skp1p1-cdk2p1p2-cycA) (available Skp2p1-Skp1p1)))
	(preference p0S (or (available Skp2-Skp1p1-cdk2-cycA) (available Raf1-cdc25A)))
	(preference p0T (or (available p107) (available p57-cdk2p1p2-cycA)))
	(preference p0U (or (available cdc25Ap1) (available Skp2-Skp1p1-cdk2p1-cycA)))
	(preference p0V (or (available PCNA-p21-cdk2p1-cycA) (available PCNA-p21-cdk2p1p2-cycA)))
	(preference p0W (or (available pRbp1-Jun-c-Fos) (available p21-cdk2p1p2-cycA)))
	(preference p0X (or (available PCNA-p21-cdk2p2-cycA) (available pRbp1p2-AP2)))
	(preference p0Y (or (available Skp2-Skp1p1) (available PCNA-p21-cdk46p1-cycDp1)))
	(preference p0Z (or (available Raf1-pRbp1-E2F13-DP12) (available p57-cdk2p2-cycA)))
	(preference p0AB (or (available ERCC1) (available p21-cdk46p1-cycDp1)))
	(preference p0BB (or (available DP12p1) (available p57-cdk2-cycEp1)))
