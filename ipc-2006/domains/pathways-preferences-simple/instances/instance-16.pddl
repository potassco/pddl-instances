...
(:goal
	(and
	(preference p0A (or (available cdk46p2-cycD) (available Raf1-pRb-E2F13p1-DP12)))
	(preference p0B (or (available p16-cdk46p2) (available cdk2p1p2-cycA-E2F13p1)))
	(preference p0C (or (available Skp2-Skp1p1-cdk2p1p2-cycA) (available p57-cdk46p2-cycDp1)))
	(preference p0D (or (available PCNA-p21-cdk46-cycDp1) (available p21-cdk46p2-cycDp1)))
	(preference p0E (or (available p16-cdk46) (available p27-cdk46p2-cycDp1)))
	(preference p0F (or (available p27-cdk46-cycD) (available cdk46-cycD)))
	(preference p0G (or (available p57p1-cdk46-cycD) (available Skp2-Skp1p1-cdk2-cycA)))
	(preference p0H (or (available cdk46-cycDp1) (available PCNA-cycDp1)))
	(preference p0I (or (available cdk46p2-cycDp1) (available cdk46)))
	(preference p0J (or (available Raf1-cdc25Ap1) (available cdc25Ap1)))
	(preference p0K (or (available cdk46p2) (available E2F4-DP12-gE2)))
	(preference p0L (or (available p27-cdk2p1-cycA) (available Skp2-Skp1p1-cdk2p2-cycA)))
	(preference p0M (or (available Raf1-cdc25A) (available c-Abl-pRbp1p2)))
	(preference p0N (or (available p27p1-cdk2p2-cycE) (available p27p1-cdk46-cycD)))
	(preference p0O (or (available p27-cdk46p2-cycD) (available Skp2-cdk2p1-cycA)))
	(preference p0P (or (available p27p1-cdk46-cycDp1) (available Skp2-Skp1p1-cdk2p1-cycA)))
	(preference p0Q (or (available p57p1-cdk46p2-cycD) (available p27p1-cdk46p2-cycDp1)))
	(preference p0R (or (available cdk2p2-cycA) (available PCNA-p21-cdk46-cycD)))
	(preference p0S (or (available pRbp1-E2F4-DP12) (available cdk2-cycA-E2F13p1)))
	(preference p0T (or (available p27p1-cdk2p1p2-cycA) (available p21-cdk46-cycDp1)))
...
(:metric minimize (+ (* 1.4 (is-violated p0A))
		     (* 1.3 (is-violated p0B))
		     (* 1.4 (is-violated p0C))
		     (* 1.2 (is-violated p0D))
		     (* 1.2 (is-violated p0E))
