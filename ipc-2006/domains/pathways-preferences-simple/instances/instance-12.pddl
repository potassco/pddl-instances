...
(:goal
	(and
	(preference p0A (or (available Skp2-Skp1p1-cdk2p1-cycA) (available Wee1p1)))
	(preference p0B (or (available Skp2p1) (available CEBP-pRbp1p2-gP)))
	(preference p0C (or (available p27p1-cdk2p1-cycE) (available Skp2-Skp1p1-cdk2p2-cycA)))
	(preference p0D (or (available pRbp1p2-AP2-gE-c) (available SL1p1)))
	(preference p0E (or (available Skp2-Skp1p1-cdk2-cycA) (available cdk2p1-cycE)))
	(preference p0F (or (available cdk1p3-cycA) (available cdk1p1p3-cycB)))
	(preference p0G (or (available Skp2p1-Skp1) (available Skp2-Skp1p1-cdk2p1p2-cycA)))
	(preference p0H (or (available cdc25A) (available p27-cdk2p2-cycA)))
	(preference p0I (or (available p27p1-cdk2p1p2-cycA) (available p27p1-cdk2-cycA)))
	(preference p0J (or (available cdk1p3-cycB) (available p27p1-cdk2p1p2-cycE)))
	(preference p0K (or (available p27p1-cdk2p1-cycA) (available cdk1p3-cks1)))
	(preference p0L (or (available cdk1p2p3-cycA) (available p27p1-cdk2-cycEp1)))
	(preference p0M (or (available p27p1-cdk2p2-cycE) (available p27p1-cdk2p1p2-cycEp1)))
	(preference p0N (or (available cdk1p3) (available cycDp1)))
	(preference p0O (or (available CEBP-pRbp1p2) (available p21-cdk2-cycA)))
	(preference p0P (or (available c-Myc-Max) (available pRbp1p2-AP2)))
