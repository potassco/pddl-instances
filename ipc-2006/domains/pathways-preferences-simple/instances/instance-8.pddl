...
(:goal
	(and
	(preference p0A (or (available p68p1p2) (available Skp2-Skp1p1-cdk2-cycA)))
	(preference p0B (or (available Skp2-Skp1p1-cdk2p1p2-cycA) (available Skp2-Skp1p1-cdk2p2-cycA)))
	(preference p0C (or (available Skp2-Skp1p1-cdk2p1-cycA) (available Skp2-Skp1p1)))
	(preference p0D (or (available p53p1-DP12p1) (available Skp2p1-Skp1p1)))
	(preference p0E (or (available p21-cdk2p1p2-cycEp1) (available Skp2p1-Skp1)))
	(preference p0F (or (available p53-DP12p1) (available p21-cdk2p1-cycE)))
	(preference p0G (or (available Skp2-Skp1-cdk2-cycA) (available cdk2p1p2-cycE)))
	(preference p0H (or (available p21-cdk46p1p2-cycD) (available Mdm2-pRbp1p2)))
	(preference p0I (or (available cdk2p1p2-cycA) (available pRbp1p2-Jun-c-Fos-gERCC1)))
	(preference p0J (or (available ERCC1) (available HDAC1-pRb-E2F13p1-DP12p1)))
	(preference p0K (or (available Skp2-Skp1-cdk2p1p2-cycA) (available Jun-c-Fos-gERCC1)))
	(preference p0L (or (available p21-cdk2p1-cycEp1) (available SP1-p107p1-gP)))
...
(:metric minimize (+ (* 1.8 (is-violated p0A))
		     (* 1.8 (is-violated p0B))
		     (* 1.5 (is-violated p0C))
		     (* 1.8 (is-violated p0D))
		     (* 1.6 (is-violated p0E))
