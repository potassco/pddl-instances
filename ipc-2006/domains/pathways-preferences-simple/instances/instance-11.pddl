...
(:goal
	(and
	(preference p0A (or (available p57-cdk2p1-cycA) (available p57-cdk2-cycE)))
	(preference p0B (or (available PCNA-p21-cdk2-cycE) (available p21-cdk2p1-cycA)))
	(preference p0C (or (available PCNA-p21-cdk2p1-cycA) (available p57-cdk2-cycA)))
	(preference p0D (or (available Skp2-cdk2p1-cycA) (available PCNA-p21-cdk46p1-cycDp1)))
	(preference p0E (or (available p57-cdk2-cycEp1) (available PCNA-p21-cdk2-cycEp1)))
	(preference p0F (or (available cdk2p1-cycA) (available PCNA-cycDp1)))
	(preference p0G (or (available HDAC1-p130-E2F5-DP12-gE2) (available SP1-p107)))
	(preference p0H (or (available Skp2-cdk2-cycA) (available p57-cdk46p1-cycD)))
	(preference p0I (or (available cdk46p1-cycDp1) (available p57-cdk46p1-cycDp1)))
	(preference p0J (or (available PCNA-p21-cdk2-cycA) (available p19ARF)))
	(preference p0K (or (available p130-E2F5-DP12-gE2) (available p21-cdk2-cycA)))
	(preference p0L (or (available p21-cdk2-cycEp1) (available Raf1-p130-E2F5-DP12-gE2)))
	(preference p0M (or (available p107p1) (available c-Myc-Max)))
	(preference p0N (or (available SP1-p107-gP) (available p21-cdk46p1-cycD)))
	(preference p0O (or (available SP1-p107p1) (available PCNA-p21-cdk46p1-cycD)))
