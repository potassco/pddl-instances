...
(:goal
	(and
	(preference p0A (or (available p27p1-cdk2p2-cycEp1) (available HDAC1-p130-E2F4-DP12-gE2)))
	(preference p0B (or (available p27p1-cdk46p1-cycDp1) (available p27p1-cdk46p1-cycD)))
	(preference p0C (or (available p27p1-cdk2p1-cycA) (available p57-cdk2p1p2-cycA)))
	(preference p0D (or (available p27-cdk2p2-cycA) (available p57p1-cdk46p1p2-cycD)))
	(preference p0E (or (available p27p1-cdk2-cycA) (available p27-cdk2p1p2-cycE)))
	(preference p0F (or (available cdk2p1-cycA-E2F13p1) (available p21-cdk2p2-cycEp1)))
	(preference p0G (or (available p27p1) (available cdk1p1p2p3-Gadd45)))
	(preference p0H (or (available p21-cdk2-cycEp1) (available cdk2p2-cycA-E2F13p1)))
	(preference p0I (or (available p21-cdk46p1-cycDp1) (available p27p1-cdk46p1p2-cycD)))
	(preference p0J (or (available p27p1-cdk2p1-cycEp1) (available cdk2-cycA-E2F13p1)))
	(preference p0K (or (available cdk2p1p2-cycA-E2F13p1) (available HDAC1-pRb-E2F13-DP12-gE2)))
	(preference p0L (or (available p27-cdk2-cycEp1) (available p27p1-cdk2p2-cycE)))
	(preference p0M (or (available p21-cdk2p1p2-cycE) (available cdk2p2-cks1)))
	(preference p0N (or (available p57-cdk2p1p2-cycE) (available HDAC1-pRb-E2F13-DP12p1)))
	(preference p0O (or (available p68p1p2) (available p27p1-cdk2p1-cycE)))
	(preference p0P (or (available p53-DP12p1) (available Skp1p1)))
	(preference p0Q (or (available cdk1p1p2p3) (available p27p1-cdk2p1p2-cycEp1)))
	(preference p0R (or (available p53p1-DP12p1) (available HDAC1-p130-E2F5-DP12)))
	(preference p0S (or (available p27p1-cdk2p2-cycA) (available p27p1-cdk46p1p2-cycDp1)))
	(preference p0T (or (available p27p1-cdk2-cycE) (available HDAC1-p107-E2F4-DP12-gE2)))
	(preference p0U (or (available p68p1) (available p57p1-cdk46p1-cycDp1)))
	(preference p0V (or (available pRbp1-AP2) (available cdk1p1p2p3-cycB)))
	(preference p0W (or (available SP1-E2F13p1) (available p27p1-cdk2p1p2-cycA)))
	(preference p0X (or (available p27p1-cdk2p1p2-cycE) (available p27p1-cdk2-cycEp1)))
