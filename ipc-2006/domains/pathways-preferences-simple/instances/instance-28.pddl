...
(:goal
	(and
	(preference p0A (or (available p57p1-cdk46-cycD) (available p57p1-cdk46p2-cycDp1)))
	(preference p0B (or (available cdk46p2-cycD) (available cdk46-cycDp1)))
	(preference p0C (or (available PCNA-p21-cdk46-cycD) (available p57p1-cdk46-cycDp1)))
	(preference p0D (or (available p16-cdk46p2) (available p21-cdk46p2-cycDp1)))
	(preference p0E (or (available HDAC1-p130-E2F5-DP12p1) (available p57-cdk46p2-cycD)))
	(preference p0F (or (available cdk46p2-cycDp1) (available p21-cdk46-cycDp1)))
	(preference p0G (or (available cdk46-cycD) (available p21-cdk46-cycD)))
	(preference p0H (or (available cdk46p2) (available SP1-E2F13p1-gP)))
	(preference p0I (or (available PCNA-p21-cdk46p2-cycDp1) (available Raf1-cdc25A)))
	(preference p0J (or (available p16-cdk46) (available cdc25Ap1)))
	(preference p0K (or (available Raf1-cdc25Ap1) (available pRbp2-AP2-gE-c)))
	(preference p0L (or (available PCNA-p21-cdk46-cycDp1) (available p57-cdk46p2-cycDp1)))
	(preference p0M (or (available cdk46) (available cycA)))
	(preference p0N (or (available p57-cdk46-cycDp1) (available p57p1-cdk46p2-cycD)))
	(preference p0O (or (available p57-cdk46-cycD) (available cdk2p1p2-cycA-E2F13p1)))
	(preference p0P (or (available p21-cdk46p2-cycD) (available p53p1-DP12p1)))
	(preference p0Q (or (available pRbp1p2-AP2) (available PCNA-p21-cdk46p2-cycD)))
	(preference p0R (or (available cdk2p1-cycA-E2F13p1) (available cdk2p2-cycA-E2F13p1)))
	(preference p0S (or (available cdc25A) (available p21-cdk2p1p2-cycE)))
	(preference p0T (or (available c-Myc-Max) (available cdk2-cycA-E2F13p1)))
	(preference p0U (or (available SP1-E2F13p1) (available p21-cdk46p1-cycD)))
	(preference p0V (or (available PCNA-p21-cdk2p2-cycE) (available pRbp1-Jun-c-Fos-gERCC1)))
	(preference p0W (or (available p21-cdk2p1-cycA) (available p16-cdk7p1)))
	(preference p0X (or (available Mdm2-E2F13-DP12) (available p57-cdk2p2-cycE)))
	(preference p0Y (or (available Skp2-cdk2p1p2-cycA) (available p57p1-cdk46p1p2-cycD)))
	(preference p0Z (or (available Raf1-p130-E2F5-DP12-gE2) (available p57-cdk2p1p2-cycEp1)))
	(preference p0AB (or (available cdk2p1-cycE) (available cdk2-cycE)))
	(preference p0BB (or (available cdk2p1p2-cycA) (available p21-cdk2-cycEp1)))
	(preference p0CB (or (available pRbp1p2-Jun) (available DP12p1)))
	(preference p0DB (or (available SP1-p107) (available p57-cdk2p1-cycE)))
	(preference p0EB (or (available PCNA-p21-cdk2p1p2-cycE) (available SP1-p107p1-gP)))
	(preference p0FB (or (available PCNA-p21-cdk2-cycA) (available p19ARF)))
	(preference p0GB (or (available p57-cdk2p1-cycA) (available Skp2-cdk2p2-cycA)))
	(preference p0HB (or (available pRbp1-E2F13-DP12-gE2) (available p16-cdk46p1p2)))
	(preference p0IB (or (available m1433-cdc25Cp1p2) (available p57-cdk2p2-cycA)))
	(preference p0JB (or (available PCNA-p21-cdk2p1-cycE) (available pRbp1p2-AP2-gE-c)))
	(preference p0KB (or (available Skp2p1) (available Raf1-pRbp1-E2F13p1-DP12p1-gE2)))
	...
	(preference p30A (not (num-subs l30)))
	(preference p31A (not (num-subs l31)))
	(preference p32A (not (num-subs l32)))
	(preference p33A (not (num-subs l33)))
	(preference p34A (not (num-subs l34)))
	(preference p35A (not (num-subs l35)))))
...
(:metric minimize (+ (* 1.1 (is-violated p0A))
		     ...
		     (* 1.1 (is-violated p0Y))
		     (* 1.1 (is-violated p0Z))
		     (* 1.0 (is-violated p0AB))
		     (* 1.1 (is-violated p0BB))
		     (* 1.1 (is-violated p0CB))
		     (* 1.0 (is-violated p0DB))
		     (* 1.0 (is-violated p0EB))
		     (* 1.1 (is-violated p0FB))
		     (* 1.1 (is-violated p0GB))
		     (* 1.1 (is-violated p0HB))
		     (* 1.1 (is-violated p0IB))
		     (* 1.1 (is-violated p0JB))
		     (* 1.1 (is-violated p0KB))
		     (* 1 (is-violated p1A))
		     (* 2 (is-violated p2A))
		     (* 3 (is-violated p3A))
		     (* 4 (is-violated p4A))
