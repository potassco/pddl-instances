...
(:goal
	(and
	(preference p0A (or (available p27-cdk46-cycDp1) (available Raf1-cdc25A)))
	(preference p0B (or (available HDAC1-p130-E2F5-DP12p1) (available cdk2-cycA)))
	(preference p0C (or (available cycE) (available Raf1-cdc25Ap1)))
	(preference p0D (or (available SP1-E2F13p1-gP) (available p27p1-cdk2-cycE)))
	(preference p0E (or (available Raf1-pRb-E2F13p1-DP12p1) (available pRbp2-Jun-c-Fos)))
	(preference p0F (or (available CEBP-pRbp1p2-gP) (available p53-DP12p1)))
	(preference p0G (or (available p27p1-cdk46p1-cycD) (available p27-cdk2p2-cycA)))
	(preference p0H (or (available p21-cdk2-cycE) (available p27p1-cdk2-cycA)))
	(preference p0I (or (available cdk2p1-cycA-E2F13p1) (available p27-cdk46-cycD)))
	(preference p0J (or (available p107-E2F4-DP12) (available cdk2p1-cycE)))
	(preference p0K (or (available cdk2p1p2-cycA) (available HDAC1-p107-E2F4-DP12-gE2)))
	(preference p0L (or (available p68p1) (available PCNA-p21-cdk2-cycE)))
	(preference p0M (or (available p16-cdk46) (available DMP1-cycD)))
	(preference p0N (or (available p27p1-cdk2-cycEp1) (available p21-cdk2p2-cycE)))
	(preference p0O (or (available Raf1-pRbp1-E2F13-DP12p1-gE2) (available cdc25Ap1)))
	(preference p0P (or (available p27-cdk2-cycA) (available p16-cdk7p1)))
	(preference p0Q (or (available cdc25A) (available cdk46p2-cycDp1)))
	(preference p0R (or (available pRbp1p2-Jun-c-Fos-gERCC1) (available PCNA-p21-cdk2p1-cycEp1)))
	(preference p0S (or (available p57-cdk46p2-cycDp1) (available p57p1-cdk46-cycD)))
	(preference p0T (or (available p27-cdk46p1-cycD) (available pRbp1-E2F4-DP12-gE2)))
	(preference p0U (or (available PCNA-p21-cdk2-cycA) (available p27p1-cdk46p2-cycDp1)))
	(preference p0V (or (available p27-cdk2p1-cycEp1) (available p21-cdk2-cycA)))
	(preference p0W (or (available HDAC1-pRb-E2F4-DP12) (available p27-cdk46p2-cycDp1)))
	(preference p0X (or (available SP1-E2F13p1) (available p57-cdk2p2-cycE)))
	(preference p0Y (or (available cdk2-cycA-E2F13p1) (available cdk2-cycE)))
	(preference p0Z (or (available cdk46-cycD) (available Skp2p1)))
