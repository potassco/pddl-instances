...
(:goal (and
	...
	(preference p6A (imply (stored goods4 level1) (stored goods12 level2)))
	(preference p6B (imply (stored goods4 level2) (stored goods12 level4)))
	(preference p6C (imply (stored goods4 level3) (stored goods12 level6)))
	(preference p6D (not (stored goods4 level4)))
	(preference p6E (not (stored goods4 level5)))
	(preference p6F (not (stored goods4 level6)))

	(preference p6G (imply (stored goods5 level1) (stored goods16 level2)))
	(preference p6H (imply (stored goods5 level2) (stored goods16 level4)))
	(preference p6I (imply (stored goods5 level3) (stored goods16 level6)))
	(preference p6J (not (stored goods5 level4)))
	(preference p6K (not (stored goods5 level5)))
	(preference p6L (not (stored goods5 level6)))

	(forall (?l - level)
	   (preference p6M (imply (stored goods1 ?l) (stored goods8 ?l))))

	(forall (?l - level)
	   (preference p6N (imply (stored goods10 ?l) (stored goods15 ?l))))

	(forall (?l - level)
	   (preference p6O (imply (stored goods10 ?l) (stored goods14 ?l))))

	(forall (?l - level)
	   (preference p6P (imply (stored goods4 ?l) (stored goods7 ?l))))
