...
(:goal (and
	...
	(forall (?l - level)
	   (preference p7A (imply (stored goods12 ?l) (stored goods18 ?l))))

	(forall (?l - level)
	   (preference p7B (imply (stored goods15 ?l) (stored goods20 ?l))))

	(preference p7C (imply (stored goods7 level1) (stored goods14 level2)))
	(preference p7D (imply (stored goods7 level2) (stored goods14 level4)))
	(preference p7E (imply (stored goods7 level3) (stored goods14 level6)))
	(preference p7F (not (stored goods7 level4)))
	(preference p7G (not (stored goods7 level5)))
	(preference p7H (not (stored goods7 level6)))
	(preference p7I (not (stored goods7 level7)))

	(forall (?l - level)
	   (preference p7J (imply (stored goods8 ?l) (stored goods20 ?l))))

	(forall (?l - level)
	   (preference p7K (imply (stored goods2 ?l) (stored goods13 ?l))))

	(preference p7L (imply (stored goods16 level1) (stored goods19 level2)))
	(preference p7M (imply (stored goods16 level2) (stored goods19 level4)))
	(preference p7N (imply (stored goods16 level3) (stored goods19 level6)))
	(preference p7O (not (stored goods16 level4)))
	(preference p7P (not (stored goods16 level5)))
	(preference p7Q (not (stored goods16 level6)))
	(preference p7R (not (stored goods16 level7)))

	(forall (?l - level)
	   (preference p7S (imply (stored goods16 ?l) (stored goods18 ?l))))
