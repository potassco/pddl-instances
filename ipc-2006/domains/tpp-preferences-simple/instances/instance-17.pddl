...
(:goal (and
	...
	(forall (?l - level)
	   (preference p7A (imply (stored goods17 ?l) (stored goods19 ?l))))

	(preference p7B (imply (stored goods1 level1) (stored goods17 level2)))
	(preference p7C (imply (stored goods1 level2) (stored goods17 level4)))
	(preference p7D (imply (stored goods1 level3) (stored goods17 level6)))
	(preference p7E (not (stored goods1 level4)))
	(preference p7F (not (stored goods1 level5)))
	(preference p7G (not (stored goods1 level6)))
	(preference p7H (not (stored goods1 level7)))

	(forall (?l - level)
	   (preference p7I (imply (stored goods2 ?l) (stored goods13 ?l))))

	(preference p7J (imply (stored goods6 level1) (stored goods12 level2)))
	(preference p7K (imply (stored goods6 level2) (stored goods12 level4)))
	(preference p7L (imply (stored goods6 level3) (stored goods12 level6)))
	(preference p7M (not (stored goods6 level4)))
	(preference p7N (not (stored goods6 level5)))
	(preference p7O (not (stored goods6 level6)))
	(preference p7P (not (stored goods6 level7)))

	(forall (?l - level)
	   (preference p7Q (imply (stored goods9 ?l) (stored goods19 ?l))))

	(forall (?l - level)
	   (preference p7R (imply (stored goods9 ?l) (stored goods19 ?l))))

	(preference p7S (imply (stored goods11 level1) (stored goods19 level2)))
	(preference p7T (imply (stored goods11 level2) (stored goods19 level4)))
	(preference p7U (imply (stored goods11 level3) (stored goods19 level6)))
	(preference p7V (not (stored goods11 level4)))
	(preference p7W (not (stored goods11 level5)))
	(preference p7X (not (stored goods11 level6)))
	(preference p7Y (not (stored goods11 level7)))
