...
(:goal (and
	...
	(preference p6A (imply (stored goods15 level1) (stored goods16 level2)))
	(preference p6B (imply (stored goods15 level2) (stored goods16 level4)))
	(preference p6C (imply (stored goods15 level3) (stored goods16 level6)))
	(preference p6D (not (stored goods15 level4)))
	(preference p6E (not (stored goods15 level5)))
	(preference p6F (not (stored goods15 level6)))

	(forall (?l - level)
	   (preference p6G (imply (stored goods9 ?l) (stored goods10 ?l))))

	(forall (?l - level)
	   (preference p6H (imply (stored goods8 ?l) (stored goods16 ?l))))

	(preference p6I (imply (stored goods8 level1) (stored goods14 level2)))
	(preference p6J (imply (stored goods8 level2) (stored goods14 level4)))
	(preference p6K (imply (stored goods8 level3) (stored goods14 level6)))
	(preference p6L (not (stored goods8 level4)))
	(preference p6M (not (stored goods8 level5)))
	(preference p6N (not (stored goods8 level6)))

	(preference p6O (imply (stored goods9 level1) (stored goods17 level2)))
	(preference p6P (imply (stored goods9 level2) (stored goods17 level4)))
	(preference p6Q (imply (stored goods9 level3) (stored goods17 level6)))
	(preference p6R (not (stored goods9 level4)))
	(preference p6S (not (stored goods9 level5)))
	(preference p6T (not (stored goods9 level6)))

	(preference p6U (imply (stored goods10 level1) (stored goods14 level2)))
	(preference p6V (imply (stored goods10 level2) (stored goods14 level4)))
	(preference p6W (imply (stored goods10 level3) (stored goods14 level6)))
	(preference p6X (not (stored goods10 level4)))
	(preference p6Y (not (stored goods10 level5)))
	(preference p6Z (not (stored goods10 level6)))
