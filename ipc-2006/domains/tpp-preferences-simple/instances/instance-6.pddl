...
(:goal (and
	...
	(preference p4A (imply (stored goods7 level1) (stored goods8 level2)))
	(preference p4B (imply (stored goods7 level2) (stored goods8 level4)))
	(preference p4C (not (stored goods7 level3)))
	(preference p4D (not (stored goods7 level4)))

	(forall (?l - level)
	   (preference p4E (imply (stored goods5 ?l) (stored goods8 ?l))))

	(forall (?l - level)
	   (preference p4F (imply (stored goods4 ?l) (stored goods8 ?l))))
