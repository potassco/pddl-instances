...
(:goal (and
	...
	(forall (?l - level)
	   (preference p7A (imply (stored goods14 ?l) (stored goods21 ?l))))

	(preference p7B (imply (stored goods16 level1) (stored goods18 level2)))
	(preference p7C (imply (stored goods16 level2) (stored goods18 level4)))
	(preference p7D (imply (stored goods16 level3) (stored goods18 level6)))
	(preference p7E (not (stored goods16 level4)))
	(preference p7F (not (stored goods16 level5)))
	(preference p7G (not (stored goods16 level6)))
	(preference p7H (not (stored goods16 level7)))

	(preference p7I (imply (stored goods4 level1) (stored goods14 level2)))
	(preference p7J (imply (stored goods4 level2) (stored goods14 level4)))
	(preference p7K (imply (stored goods4 level3) (stored goods14 level6)))
	(preference p7L (not (stored goods4 level4)))
	(preference p7M (not (stored goods4 level5)))
	(preference p7N (not (stored goods4 level6)))
	(preference p7O (not (stored goods4 level7)))

	(forall (?l - level)
	   (preference p7P (imply (stored goods8 ?l) (stored goods19 ?l))))

	(preference p7Q (imply (stored goods8 level1) (stored goods15 level2)))
	(preference p7R (imply (stored goods8 level2) (stored goods15 level4)))
	(preference p7S (imply (stored goods8 level3) (stored goods15 level6)))
	(preference p7T (not (stored goods8 level4)))
	(preference p7U (not (stored goods8 level5)))
	(preference p7V (not (stored goods8 level6)))
	(preference p7W (not (stored goods8 level7)))

	(forall (?l - level)
	   (preference p7X (imply (stored goods8 ?l) (stored goods15 ?l))))

	(preference p7Y (imply (stored goods16 level1) (stored goods18 level2)))
	(preference p7Z (imply (stored goods16 level2) (stored goods18 level4)))
	(preference p7AB (imply (stored goods16 level3) (stored goods18 level6)))
	(preference p7BB (not (stored goods16 level4)))
	(preference p7CB (not (stored goods16 level5)))
	(preference p7DB (not (stored goods16 level6)))
	(preference p7EB (not (stored goods16 level7)))

	(preference p7FB (imply (stored goods14 level1) (stored goods19 level2)))
	(preference p7GB (imply (stored goods14 level2) (stored goods19 level4)))
	(preference p7HB (imply (stored goods14 level3) (stored goods19 level6)))
	(preference p7IB (not (stored goods14 level4)))
	(preference p7JB (not (stored goods14 level5)))
	(preference p7KB (not (stored goods14 level6)))
	(preference p7LB (not (stored goods14 level7)))
