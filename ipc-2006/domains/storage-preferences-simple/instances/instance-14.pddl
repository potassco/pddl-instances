...
(:goal (and
	(preference p5A (clear depot0-2-3))
	...
	(preference p2B (clear depot1-1-1))
	(preference p2C (clear depot1-2-2))
	(preference p1B (clear depot1-1-2))
	(preference p4B (clear depot2-2-1))
	(preference p2D (clear depot2-1-1))
	(preference p2E (clear depot2-2-2))
	(preference p1C (clear depot2-1-2))
	(preference p5B (clear depot3-2-3))
	(preference p3B (clear depot3-1-3))
	(preference p2F (clear depot3-1-2))
	(preference p1D (clear depot3-1-1))
	(preference p3C (clear depot4-2-2))
	(preference p1E (clear depot4-1-2))
	(preference p1F (clear depot4-2-1))
	(preference p4C (clear depot5-2-1))
	(preference p2G (clear depot5-1-1))
	(preference p2H (clear depot5-2-2))
	(preference p1G (clear depot5-1-2))
	(preference p5C (clear depot6-2-3))
	(preference p3D (clear depot6-1-3))
	(preference p2I (clear depot6-1-2))
	(preference p1H (clear depot6-1-1))
	(preference p3E (clear depot7-2-2))
	(preference p1I (clear depot7-1-2))
	(preference p1J (clear depot7-2-1))
	...
	(forall (?c - crate)
	   (preference p26A (exists (?d - depot) (and (in ?c ?d) (not (= ?d depot5))))))
	(forall (?c - crate)
	   (preference p31A (exists (?d - depot) (and (in ?c ?d) (not (= ?d depot6))))))
	(forall (?c - crate)
	...
	(forall (?h - hoist)
	   (preference p22B (exists (?s - storearea ?d - depot)
			      (and (at ?h ?s) (in ?s ?d) (not (= ?d depot4))))))
	(forall (?h - hoist)
	   (preference p26B (exists (?s - storearea ?d - depot)
			      (and (at ?h ?s) (in ?s ?d) (not (= ?d depot5))))))
	(forall (?h - hoist)
	   (preference p31B (exists (?s - storearea ?d - depot)
			      (and (at ?h ?s) (in ?s ?d) (not (= ?d depot6))))))
	(forall (?h - hoist)
	   (preference p37B (exists (?s - storearea ?d - depot)
	...
	(forall (?c1 ?c2 - crate ?s1 ?s2 - storearea)
	   (preference p19A (imply (and (on ?c1 ?s1) (on ?c2 ?s2)
			               (not (= ?c1 ?c2)) (connected ?s1 ?s2))
			          (compatible ?c1 ?c2))))

	(forall (?d - depot ?s - storearea ?h - hoist)
	   (preference p38A (imply (and (at ?h ?s) (in ?s ?d))
