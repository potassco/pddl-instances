...
(:goal (and
	...
	(preference p5B (clear depot4-2-3))
	(preference p3D (clear depot4-1-3))
	(preference p2D (clear depot4-1-2))
	...
	(preference p3G (clear depot7-2-2))
	(preference p1L (clear depot7-1-2))
	(preference p1M (clear depot7-2-1))
	(preference p5C (clear depot8-2-3))
	(preference p3H (clear depot8-1-3))
	(preference p2E (clear depot8-1-2))
	(preference p1N (clear depot8-1-1))
	...
	(forall (?c - crate)
	   (preference p30A (exists (?d - depot) (and (in ?c ?d) (not (= ?d depot6))))))
	(forall (?c - crate)
	...
	(forall (?h - hoist)
	   (preference p30B (exists (?s - storearea ?d - depot)
