...
(:goal (and
	...
	(preference p1E (clear depot2-2-1))
	(preference p3C (clear depot3-2-2))
	(preference p1F (clear depot3-1-2))
	(preference p1G (clear depot3-2-1))
	(preference p3D (clear depot4-2-1))
	(preference p1H (clear depot4-1-1))
	(preference p1I (clear depot4-2-2))
...
(:constraints (and
	(forall (?c1 ?c2 - crate ?s1 ?s2 - storearea)
	   (preference p11A (always (imply (and (on ?c1 ?s1) (on ?c2 ?s2)
	...
	(preference p5F (sometime-before (exists (?d1 - depot) (in crate1 ?d1))
					 (exists (?d2 - depot) (in crate2 ?d2))))
	(preference p5G (sometime-before (exists (?d1 - depot) (in crate1 ?d1))
					 (exists (?d2 - depot) (in crate3 ?d2))))
	(preference p5H (sometime-before (exists (?d1 - depot) (in crate1 ?d1))
					 (exists (?d2 - depot) (in crate4 ?d2))))
	(preference p5I (sometime-before (exists (?d1 - depot) (in crate1 ?d1))
					 (exists (?d2 - depot) (in crate5 ?d2))))
	(preference p5J (sometime-before (exists (?d1 - depot) (in crate1 ?d1))
					 (exists (?d2 - depot) (in crate6 ?d2))))

	(forall (?c - crate)
	   (preference p7C (within 74 (exists (?d - depot) (in ?c ?d)))))

	(forall (?h - hoist)
	   (preference p6B (always-within 3.5 (at ?h loadarea)
