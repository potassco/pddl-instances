...
(:goal (and
	...
	(preference p3E (clear depot4-1-3))
	(preference p2A (clear depot4-1-2))
	(preference p1I (clear depot4-1-1))
	(preference p4A (clear depot5-2-1))
	(preference p2B (clear depot5-1-1))
	(preference p2C (clear depot5-2-2))
...
(:constraints (and
	(forall (?c1 ?c2 - crate ?s1 ?s2 - storearea)
	   (preference p19A (always (imply (and (on ?c1 ?s1) (on ?c2 ?s2)
	...
	(preference p6BA (sometime-before (exists (?d1 - depot) (in crate2 ?d1))
					 (exists (?d2 - depot) (in crate12 ?d2))))
	(preference p6BB (sometime-before (exists (?d1 - depot) (in crate3 ?d1))
					 (exists (?d2 - depot) (in crate4 ?d2))))
	(preference p6BC (sometime-before (exists (?d1 - depot) (in crate3 ?d1))
					 (exists (?d2 - depot) (in crate5 ?d2))))
	(preference p6BD (sometime-before (exists (?d1 - depot) (in crate3 ?d1))
					 (exists (?d2 - depot) (in crate6 ?d2))))
	(preference p6BE (sometime-before (exists (?d1 - depot) (in crate3 ?d1))
					 (exists (?d2 - depot) (in crate7 ?d2))))
	(preference p6BF (sometime-before (exists (?d1 - depot) (in crate3 ?d1))
					 (exists (?d2 - depot) (in crate8 ?d2))))
	(preference p6BG (sometime-before (exists (?d1 - depot) (in crate3 ?d1))
					 (exists (?d2 - depot) (in crate9 ?d2))))
	(preference p6BH (sometime-before (exists (?d1 - depot) (in crate3 ?d1))
					 (exists (?d2 - depot) (in crate10 ?d2))))
	(preference p6BI (sometime-before (exists (?d1 - depot) (in crate3 ?d1))
					 (exists (?d2 - depot) (in crate11 ?d2))))
	(preference p6BJ (sometime-before (exists (?d1 - depot) (in crate3 ?d1))
					 (exists (?d2 - depot) (in crate12 ?d2))))

	(forall (?c - crate)
	   (preference p10A (within 74 (exists (?d - depot) (in ?c ?d)))))

	(forall (?h - hoist)
	   (preference p9C (always-within 3.5 (at ?h loadarea)
