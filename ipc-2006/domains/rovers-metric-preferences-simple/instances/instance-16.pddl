...
(define (problem roverprob17923-2)
        (:domain rover)
        ...
        (:init (visible waypoint0 waypoint6) (visible waypoint6 waypoint0)
         ...
         (calibration_target camera1 objective14) (supports camera1 colour)
         (supports camera1 high_res) (supports camera1 low_res)
         (on_board camera2 rover0) (calibration_target camera2 objective12)
         ...
         (and (preference g0 (communicated_soil_data waypoint14))
              ...
              (preference g5
               (and (communicated_rock_data waypoint6)
                    (communicated_soil_data waypoint14)))
              (preference g6 (communicated_soil_data waypoint13))
              (preference g7
               (and (communicated_rock_data waypoint14)
                    (communicated_soil_data waypoint13)))
              (preference g8 (communicated_soil_data waypoint12))
              (preference g9
               (and (communicated_rock_data waypoint14)
              ...
              (preference g19
               (and (communicated_rock_data waypoint6)
                    (communicated_rock_data waypoint14)))
              (preference g20 (communicated_rock_data waypoint12))
              (preference g21 (communicated_rock_data waypoint6))))
        (:metric minimize
         (+ (* (is-violated g21) 213.7)
            (* (is-violated g20) 199.4)
            (* (is-violated g19) 58.9)
            (* (is-violated g18) 491.9)
            (* (is-violated g17) 34.2)
            (* (is-violated g16) 309.1)
            (* (is-violated g15) 76.3)
            (* (is-violated g14) 165.8)
            (* (is-violated g13) 322.5)
            (* (is-violated g12) 235)
            (* (is-violated g11) 622.1)
            (* (is-violated g10) 225)
            (* (is-violated g9) 44.8)
            (* (is-violated g8) 245.9)
            (* (is-violated g7) 250.6)
            (* (is-violated g6) 97.1)
            (* (is-violated g5) 245.1)
            (* (is-violated g4) 229.7)
            (* (is-violated g3) 12.6)
            (* (is-violated g2) 494.9)
            (* (is-violated g1) 432.3)
            (* (is-violated g0) 65.1)
            (sum-traverse-cost))))
