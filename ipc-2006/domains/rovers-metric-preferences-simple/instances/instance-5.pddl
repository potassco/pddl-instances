...
(define (problem roverprob31337-3)
        ...
        (:goal
         (and (preference g0 (communicated_soil_data waypoint9))
              ...
              (preference g2 (communicated_rock_data waypoint7))
              (preference g3 (communicated_rock_data waypoint2))
              (preference g4 (communicated_image_data objective7 colour))
              (preference g5 (communicated_image_data objective4 colour))))
        (:metric minimize
         (+ (* (is-violated g5) 210.5)
            (* (is-violated g4) 140.3)
            (* (is-violated g3) 61.8)
            (* (is-violated g2) 138.5)
            (* (is-violated g1) 126.3)
            (* (is-violated g0) 375)
            (sum-traverse-cost))))
