...
(define (problem os-soft-wbop_20_20-35-fixed15)
        ...
        (:objects n0 - count n1 - count n2 - count n3 - count n4 - count n5 -
         ...
         - order p1 - product p2 - product p3 - product p4 - product p5 -
         product p6 - product p7 - product p8 - product p9 - product p10 -
        ...
        (:init (next-count n0 n1) (next-count n1 n2) (next-count n2 n3)
         ...
         (stacks-avail n15) (waiting o1) (includes o1 p2) (includes o1 p3)
