...
(define (problem os-soft-wbop_20_20-37-fixed14)
        ...
        (:objects n0 - count n1 - count n2 - count n3 - count n4 - count n5 -
         ...
         count n12 - count n13 - count n14 - count o1 - order o2 - order o3 -
        ...
        (:init (next-count n0 n1) (next-count n1 n2) (next-count n2 n3)
         ...
         (next-count n12 n13) (next-count n13 n14) (stacks-avail n14)
