...
(define (problem os-soft-nwrssmaller4-4-fixed6)
        (:domain openstacks-soft)
        (:objects n0 - count n1 - count n2 - count n3 - count n4 - count n5 -
         count n6 - count o1 - order o2 - order o3 - order o4 - order o5 -
         order o6 - order o7 - order o8 - order o9 - order o10 - order o11 -
         order o12 - order o13 - order o14 - order o15 - order p1 - product p2
        ...
        (:init (next-count n0 n1) (next-count n1 n2) (next-count n2 n3)
         ...
         (stacks-avail n6) (waiting o1) (includes o1 p1) (includes o1 p5)
