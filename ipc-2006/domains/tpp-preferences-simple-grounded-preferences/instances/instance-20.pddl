; Compilation CPU-time: 0.35 seconds
(define (problem TPP)
...
(:init
	...
	(ready-to-load goods22 depot1 level0)
	(ready-to-load goods22 depot2 level0)
...
(:goal (and
    ...
    (preference P8A 
        (and (ready-to-load goods22 market1 level0)
     (ready-to-load goods22 market3 level0)
     (ready-to-load goods22 market4 level0)
     (loaded goods22 truck1 level0)
     (loaded goods22 truck2 level0)))
    ...
    (preference P8A 
     ...
     (loaded goods1 truck2 level0)))
    (preference P7LB 
        (not (stored goods14 level7)))
    (preference P7KB 
        (not (stored goods14 level6)))
    (preference P7JB 
        (not (stored goods14 level5)))
    (preference P7IB 
        (not (stored goods14 level4)))
    (preference P7HB 
        (or (not (stored goods14 level3))
            (stored goods19 level6)))
    (preference P7GB 
        (or (not (stored goods14 level2))
            (stored goods19 level4)))
    (preference P7FB 
        (or (not (stored goods14 level1))
            (stored goods19 level2)))
    (preference P7EB 
        (not (stored goods16 level7)))
    (preference P7DB 
        (not (stored goods16 level6)))
    (preference P7CB 
        (not (stored goods16 level5)))
    (preference P7BB 
        (not (stored goods16 level4)))
    (preference P7AB 
        (or (not (stored goods16 level3))
            (stored goods18 level6)))
    (preference P7Z 
        (or (not (stored goods16 level2))
            (stored goods18 level4)))
    (preference P7Y 
        (or (not (stored goods16 level1))
            (stored goods18 level2)))
    (preference P7X 
        (or (not (stored goods8 level7))
    ...
    (preference P7P 
        (or (not (stored goods8 level0))
            (stored goods19 level0)))
    (preference P7O 
        (not (stored goods4 level7)))
    (preference P7N 
        (not (stored goods4 level6)))
    (preference P7M 
        (not (stored goods4 level5)))
    (preference P7L 
        (not (stored goods4 level4)))
    (preference P7K 
    ...
    (preference P7B 
        (or (not (stored goods16 level1))
            (stored goods18 level2)))
    (preference P7A 
        (or (not (stored goods14 level7))
            (stored goods21 level7)))
    (preference P7A 
        (or (not (stored goods14 level6))
            (stored goods21 level6)))
    (preference P7A 
        (or (not (stored goods14 level5))
            (stored goods21 level5)))
    (preference P7A 
        (or (not (stored goods14 level4))
...
(:metric minimize (+ (* 1 (is-violated p0A))
		     ...
		     (* 128 (is-violated p7Y))
		     (* 128 (is-violated p7Z))
		     (* 128 (is-violated p7AB))
		     (* 128 (is-violated p7BB))
		     (* 128 (is-violated p7CB))
		     (* 128 (is-violated p7DB))
		     (* 128 (is-violated p7EB))
		     (* 128 (is-violated p7FB))
		     (* 128 (is-violated p7GB))
		     (* 128 (is-violated p7HB))
		     (* 128 (is-violated p7IB))
		     (* 128 (is-violated p7JB))
		     (* 128 (is-violated p7KB))
		     (* 128 (is-violated p7LB))
		     (* 256 (is-violated p8A))
