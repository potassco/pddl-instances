; Compilation CPU-time: 0.31 seconds
(define (problem TPP)
...
(:goal (and
    ...
    (preference P8A 
     ...
     (loaded goods1 truck2 level0)))
    (preference P7Y 
        (not (stored goods11 level7)))
    (preference P7X 
        (not (stored goods11 level6)))
    (preference P7W 
        (not (stored goods11 level5)))
    (preference P7V 
        (not (stored goods11 level4)))
    (preference P7U 
        (or (not (stored goods11 level3))
            (stored goods19 level6)))
    (preference P7T 
        (or (not (stored goods11 level2))
            (stored goods19 level4)))
    (preference P7S 
        (or (not (stored goods11 level1))
    ...
    (preference P7Q 
        (or (not (stored goods9 level0))
            (stored goods19 level0)))
    (preference P7P 
        (not (stored goods6 level7)))
    (preference P7O 
        (not (stored goods6 level6)))
    (preference P7N 
        (not (stored goods6 level5)))
    (preference P7M 
        (not (stored goods6 level4)))
    (preference P7L 
        (or (not (stored goods6 level3))
            (stored goods12 level6)))
    (preference P7K 
        (or (not (stored goods6 level2))
            (stored goods12 level4)))
    (preference P7J 
        (or (not (stored goods6 level1))
    ...
    (preference P7I 
        (or (not (stored goods2 level0))
            (stored goods13 level0)))
    (preference P7H 
        (not (stored goods1 level7)))
    (preference P7G 
        (not (stored goods1 level6)))
    (preference P7F 
        (not (stored goods1 level5)))
    (preference P7E 
    ...
    (preference P7A 
        (or (not (stored goods17 level7))
            (stored goods19 level7)))
    (preference P7A 
        (or (not (stored goods17 level6))
            (stored goods19 level6)))
    (preference P7A 
        (or (not (stored goods17 level5))
            (stored goods19 level5)))
    (preference P7A 
        (or (not (stored goods17 level4))
            (stored goods19 level4)))
    (preference P7A 
        (or (not (stored goods17 level3))
            (stored goods19 level3)))
    (preference P7A 
        (or (not (stored goods17 level2))
            (stored goods19 level2)))
    (preference P7A 
        (or (not (stored goods17 level1))
            (stored goods19 level1)))
    (preference P7A 
        (or (not (stored goods17 level0))
            (stored goods19 level0)))
    (preference P6A 
        (stored goods19 level7))
    (preference P6A 
