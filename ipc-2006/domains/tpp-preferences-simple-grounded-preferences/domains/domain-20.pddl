...
(:constants level0 - level  goods1 goods2 goods3 goods4 goods5 goods6 goods7 goods8 goods9 goods10 goods11 goods12 goods13 goods14 goods15 goods16 goods17 goods18 goods19 goods20 goods21 goods22 - goods )
...
(:action drive
 ...
 :precondition (and (at ?t ?from) (connected ?from ?to)
                (preference p-drive (and
                        ...
                        (ready-to-load goods20 ?from level0)
                        (ready-to-load goods21 ?from level0)
                        (ready-to-load goods22 ?from level0))))
