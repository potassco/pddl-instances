...
(:init
	...
	(= (drive-cost market1 market2) 561.00)
	(= (drive-cost market2 market1) 561.00)
	(= (drive-time market1 market2) 1683.00)
	(= (drive-time market2 market1) 1683.00)
	(connected market1 market3)
	(connected market3 market1)
	(= (drive-cost market1 market3) 55.00)
	(= (drive-cost market3 market1) 55.00)
	(= (drive-time market1 market3) 165.00)
	(= (drive-time market3 market1) 165.00)
	(connected market1 market4)
	(connected market4 market1)
	(= (drive-cost market1 market4) 422.00)
	(= (drive-cost market4 market1) 422.00)
	(= (drive-time market1 market4) 1266.00)
	(= (drive-time market4 market1) 1266.00)
	(connected market2 market3)
	(connected market3 market2)
	(= (drive-cost market2 market3) 827.00)
	(= (drive-cost market3 market2) 827.00)
	(= (drive-time market2 market3) 2481.00)
	(= (drive-time market3 market2) 2481.00)
	(connected market2 market4)
	(connected market4 market2)
	(= (drive-cost market2 market4) 689.00)
	(= (drive-cost market4 market2) 689.00)
	(= (drive-time market2 market4) 2067.00)
	(= (drive-time market4 market2) 2067.00)
	(connected market3 market4)
	(connected market4 market3)
	(= (drive-cost market3 market4) 604.00)
	(= (drive-cost market4 market3) 604.00)
	(= (drive-time market3 market4) 1812.00)
	(= (drive-time market4 market3) 1812.00)
	...
	(= (drive-cost market2 depot1) 239.00)
	(= (drive-cost depot1 market2) 239.00)
	(= (drive-time market2 depot1) 717.00)
	(= (drive-time depot1 market2) 717.00)
	(connected depot1 market3)
	(connected market3 depot1)
	(= (drive-cost market3 depot1) 102.00)
	(= (drive-cost depot1 market3) 102.00)
	(= (drive-time market3 depot1) 306.00)
	(= (drive-time depot1 market3) 306.00)
	(connected depot1 market4)
	(connected market4 depot1)
	(= (drive-cost market4 depot1) 980.00)
	(= (drive-cost depot1 market4) 980.00)
	(= (drive-time market4 depot1) 2940.00)
	(= (drive-time depot1 market4) 2940.00)
	(connected depot2 market1)
	(connected market1 depot2)
	(= (drive-cost market1 depot2) 324.00)
	(= (drive-cost depot2 market1) 324.00)
	(= (drive-time market1 depot2) 972.00)
	(= (drive-time depot2 market1) 972.00)
	(connected depot2 market2)
	(connected market2 depot2)
	(= (drive-cost market2 depot2) 232.00)
	(= (drive-cost depot2 market2) 232.00)
	(= (drive-time market2 depot2) 696.00)
	(= (drive-time depot2 market2) 696.00)
	(connected depot2 market3)
	(connected market3 depot2)
	(= (drive-cost market3 depot2) 500.00)
	(= (drive-cost depot2 market3) 500.00)
	(= (drive-time market3 depot2) 1500.00)
	(= (drive-time depot2 market3) 1500.00)
	(connected depot2 market4)
	(connected market4 depot2)
	(= (drive-cost market4 depot2) 617.00)
	(= (drive-cost depot2 market4) 617.00)
	(= (drive-time market4 depot2) 1851.00)
	(= (drive-time depot2 market4) 1851.00)
...
(:constraints (and
	...
	(preference p0A (always (>= (stored goods1) (stored goods12))))

	(forall (?t - truck)
	   (preference p4A (always-within 2139.00 (> (loaded goods9 ?t) 0)
			      (= (loaded goods9 ?t) 0))))

	(forall (?t - truck)
	   (preference p4B (always-within 2139.00 (> (loaded goods14 ?t) 0)
			      (= (loaded goods14 ?t) 0))))

	(forall (?t - truck)
	   (preference p4C (always-within 762.00 (> (loaded goods11 ?t) 0)
			      (= (loaded goods11 ?t) 0))))

	(forall (?t - truck)
	   (preference p4D (always-within 2868.00 (> (loaded goods2 ?t) 0)
			      (= (loaded goods2 ?t) 0))))

	(forall (?t - truck)
	   (preference p3A (sometime (exists (?g - goods) (> (loaded ?g ?t) 0)))))

	(preference p0B (sometime-before (> (stored goods10) 0)
			   (>= (stored goods8) (request goods8))))
	...
	(preference p0G (sometime-before (> (stored goods7) 0)
