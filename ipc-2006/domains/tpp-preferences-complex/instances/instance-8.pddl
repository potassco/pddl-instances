...
(:init
	...
	(= (price goods10 market1) 24)
	(= (ready-to-load goods10 market1) 0)
	(= (on-sale goods10 market1) 11)
	(= (price goods10 market2) 32)
	(= (ready-to-load goods10 market2) 0)
	(= (on-sale goods10 market2) 16)
	(= (ready-to-load goods10 depot1) 0)
	(connected market1 market2)
	(connected market2 market1)
	(= (drive-cost market1 market2) 152.00)
	(= (drive-cost market2 market1) 152.00)
	(= (drive-time market1 market2) 456.00)
	(= (drive-time market2 market1) 456.00)
	(connected depot1 market1)
	(connected market1 depot1)
	(= (drive-cost market1 depot1) 524.00)
	(= (drive-cost depot1 market1) 524.00)
	(= (drive-time market1 depot1) 1572.00)
	(= (drive-time depot1 market1) 1572.00)
...
(:constraints (and
	...
	(preference p0A (always (>= (stored goods1) (stored goods4))))

	(forall (?t - truck)
	   (preference p4A (always-within 753.00 (> (loaded goods6 ?t) 0)
			      (= (loaded goods6 ?t) 0))))

	(forall (?t - truck)
	   (preference p4B (always-within 753.00 (> (loaded goods1 ?t) 0)
			      (= (loaded goods1 ?t) 0))))
	...
	(preference p0D (sometime-before (> (stored goods9) 0)
			   (>= (bought goods8) (request goods8))))
	(preference p0E (sometime-before (> (stored goods6) 0)
