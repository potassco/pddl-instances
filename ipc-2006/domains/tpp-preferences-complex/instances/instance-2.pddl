...
(:constraints (and
	...
	(preference p0A (always (>= (stored goods3) (stored goods1))))

	(forall (?t - truck)
	   (preference p4A (always-within 1195.00 (> (loaded goods2 ?t) 0)
			      (= (loaded goods2 ?t) 0))))

	(forall (?t - truck)
	   (preference p4B (always-within 1195.00 (> (loaded goods4 ?t) 0)
			      (= (loaded goods4 ?t) 0))))
