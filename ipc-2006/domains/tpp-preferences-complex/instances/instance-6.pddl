...
(:init
	...
	(= (drive-cost market1 depot1) 659.00)
	(= (drive-cost depot1 market1) 659.00)
	(= (drive-time market1 depot1) 1977.00)
	(= (drive-time depot1 market1) 1977.00)
	(connected depot1 market2)
	(connected market2 depot1)
	(= (drive-cost market2 depot1) 607.00)
	(= (drive-cost depot1 market2) 607.00)
	(= (drive-time market2 depot1) 1821.00)
	(= (drive-time depot1 market2) 1821.00)
...
(:constraints (and
	...
	(preference p0A (always (>= (stored goods5) (stored goods2))))

	(forall (?t - truck)
	   (preference p4A (always-within 2149.00 (> (loaded goods2 ?t) 0)
			      (= (loaded goods2 ?t) 0))))

	(forall (?t - truck)
	   (preference p4B (always-within 1993.00 (> (loaded goods6 ?t) 0)
			      (= (loaded goods6 ?t) 0))))

	(forall (?t - truck)
	   (preference p3A (sometime (exists (?g - goods) (> (loaded ?g ?t) 0)))))

	(preference p0B (sometime-before (> (stored goods4) 0)
			   (>= (stored goods8) (request goods8))))
	(preference p0C (sometime-before (> (stored goods7) 0)
			   (>= (stored goods1) (request goods1))))
	(preference p0D (sometime-before (> (stored goods3) 0)
			   (>= (stored goods6) (request goods6))))))
