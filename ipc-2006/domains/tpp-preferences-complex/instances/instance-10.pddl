...
(:init
	...
	(= (drive-cost market1 market2) 950.00)
	(= (drive-cost market2 market1) 950.00)
	(= (drive-time market1 market2) 2850.00)
	(= (drive-time market2 market1) 2850.00)
	(connected market1 market3)
	(connected market3 market1)
	(= (drive-cost market1 market3) 898.00)
	(= (drive-cost market3 market1) 898.00)
	(= (drive-time market1 market3) 2694.00)
	(= (drive-time market3 market1) 2694.00)
	(connected market2 market3)
	(connected market3 market2)
	(= (drive-cost market2 market3) 694.00)
	(= (drive-cost market3 market2) 694.00)
	(= (drive-time market2 market3) 2082.00)
	(= (drive-time market3 market2) 2082.00)
	(connected depot1 market1)
	(connected market1 depot1)
	(= (drive-cost market1 depot1) 991.00)
	(= (drive-cost depot1 market1) 991.00)
	(= (drive-time market1 depot1) 2973.00)
	(= (drive-time depot1 market1) 2973.00)
	(connected depot1 market2)
	(connected market2 depot1)
	(= (drive-cost market2 depot1) 942.00)
	(= (drive-cost depot1 market2) 942.00)
	(= (drive-time market2 depot1) 2826.00)
	(= (drive-time depot1 market2) 2826.00)
	(connected depot1 market3)
	(connected market3 depot1)
	(= (drive-cost market3 depot1) 171.00)
	(= (drive-cost depot1 market3) 171.00)
	(= (drive-time market3 depot1) 513.00)
	(= (drive-time depot1 market3) 513.00)
...
(:constraints (and
	...
	(preference p0A (always (>= (stored goods7) (stored goods1))))
	(preference p0B (always (>= (stored goods11) (stored goods3))))
	(preference p0C (always (>= (stored goods11) (stored goods9))))

	(forall (?t - truck)
	   (preference p4A (always-within 3239.00 (> (loaded goods10 ?t) 0)
			      (= (loaded goods10 ?t) 0))))

	(forall (?t - truck)
	   (preference p4B (always-within 3239.00 (> (loaded goods7 ?t) 0)
			      (= (loaded goods7 ?t) 0))))

	(forall (?t - truck)
	   (preference p4C (always-within 779.00 (> (loaded goods11 ?t) 0)
			      (= (loaded goods11 ?t) 0))))

	(forall (?t - truck)
	   (preference p4D (always-within 779.00 (> (loaded goods1 ?t) 0)
			      (= (loaded goods1 ?t) 0))))
	...
	(preference p0E (sometime-before (> (stored goods10) 0)
			   (>= (bought goods8) (request goods8))))
	(preference p0F (sometime-before (> (stored goods4) 0)
