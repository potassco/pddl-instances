...
(:init
	...
	(= (drive-cost market1 market2) 653.00)
	(= (drive-cost market2 market1) 653.00)
	(= (drive-time market1 market2) 1959.00)
	(= (drive-time market2 market1) 1959.00)
	(connected market1 market3)
	(connected market3 market1)
	(= (drive-cost market1 market3) 195.00)
	(= (drive-cost market3 market1) 195.00)
	(= (drive-time market1 market3) 585.00)
	(= (drive-time market3 market1) 585.00)
	(connected market1 market4)
	(connected market4 market1)
	(= (drive-cost market1 market4) 460.00)
	(= (drive-cost market4 market1) 460.00)
	(= (drive-time market1 market4) 1380.00)
	(= (drive-time market4 market1) 1380.00)
	(connected market1 market5)
	(connected market5 market1)
	(= (drive-cost market1 market5) 934.00)
	(= (drive-cost market5 market1) 934.00)
	(= (drive-time market1 market5) 2802.00)
	(= (drive-time market5 market1) 2802.00)
	(connected market2 market3)
	(connected market3 market2)
	(= (drive-cost market2 market3) 807.00)
	(= (drive-cost market3 market2) 807.00)
	(= (drive-time market2 market3) 2421.00)
	(= (drive-time market3 market2) 2421.00)
	(connected market2 market4)
	(connected market4 market2)
	(= (drive-cost market2 market4) 445.00)
	(= (drive-cost market4 market2) 445.00)
	(= (drive-time market2 market4) 1335.00)
	(= (drive-time market4 market2) 1335.00)
	(connected market2 market5)
	(connected market5 market2)
	(= (drive-cost market2 market5) 353.00)
	(= (drive-cost market5 market2) 353.00)
	(= (drive-time market2 market5) 1059.00)
	(= (drive-time market5 market2) 1059.00)
	(connected market3 market4)
	(connected market4 market3)
	(= (drive-cost market3 market4) 444.00)
	(= (drive-cost market4 market3) 444.00)
	(= (drive-time market3 market4) 1332.00)
	(= (drive-time market4 market3) 1332.00)
	(connected market3 market5)
	(connected market5 market3)
	(= (drive-cost market3 market5) 660.00)
	(= (drive-cost market5 market3) 660.00)
	(= (drive-time market3 market5) 1980.00)
	(= (drive-time market5 market3) 1980.00)
	(connected market4 market5)
	(connected market5 market4)
	(= (drive-cost market4 market5) 312.00)
	(= (drive-cost market5 market4) 312.00)
	(= (drive-time market4 market5) 936.00)
	(= (drive-time market5 market4) 936.00)
	(connected depot1 market1)
	(connected market1 depot1)
	(= (drive-cost market1 depot1) 341.00)
	(= (drive-cost depot1 market1) 341.00)
	(= (drive-time market1 depot1) 1023.00)
	(= (drive-time depot1 market1) 1023.00)
	(connected depot1 market2)
	(connected market2 depot1)
	(= (drive-cost market2 depot1) 740.00)
	(= (drive-cost depot1 market2) 740.00)
	(= (drive-time market2 depot1) 2220.00)
	(= (drive-time depot1 market2) 2220.00)
	(connected depot1 market3)
	(connected market3 depot1)
	(= (drive-cost market3 depot1) 883.00)
	(= (drive-cost depot1 market3) 883.00)
	(= (drive-time market3 depot1) 2649.00)
	(= (drive-time depot1 market3) 2649.00)
	(connected depot1 market4)
	(connected market4 depot1)
	(= (drive-cost market4 depot1) 469.00)
	(= (drive-cost depot1 market4) 469.00)
	(= (drive-time market4 depot1) 1407.00)
	(= (drive-time depot1 market4) 1407.00)
	(connected depot1 market5)
	(connected market5 depot1)
	(= (drive-cost market5 depot1) 393.00)
	(= (drive-cost depot1 market5) 393.00)
	(= (drive-time market5 depot1) 1179.00)
	(= (drive-time depot1 market5) 1179.00)
	(connected depot2 market1)
	(connected market1 depot2)
	(= (drive-cost market1 depot2) 646.00)
	(= (drive-cost depot2 market1) 646.00)
	(= (drive-time market1 depot2) 1938.00)
	(= (drive-time depot2 market1) 1938.00)
	(connected depot2 market2)
	(connected market2 depot2)
	(= (drive-cost market2 depot2) 285.00)
	(= (drive-cost depot2 market2) 285.00)
	(= (drive-time market2 depot2) 855.00)
	(= (drive-time depot2 market2) 855.00)
	(connected depot2 market3)
	(connected market3 depot2)
	(= (drive-cost market3 depot2) 923.00)
	(= (drive-cost depot2 market3) 923.00)
	(= (drive-time market3 depot2) 2769.00)
	(= (drive-time depot2 market3) 2769.00)
	(connected depot2 market4)
	(connected market4 depot2)
	(= (drive-cost market4 depot2) 345.00)
	(= (drive-cost depot2 market4) 345.00)
	(= (drive-time market4 depot2) 1035.00)
	(= (drive-time depot2 market4) 1035.00)
	(connected depot2 market5)
	(connected market5 depot2)
	(= (drive-cost market5 depot2) 280.00)
	(= (drive-cost depot2 market5) 280.00)
	(= (drive-time market5 depot2) 840.00)
	(= (drive-time depot2 market5) 840.00)
...
(:constraints (and
	...
	(preference p0A (always (>= (stored goods1) (stored goods10))))
	(preference p0B (always (>= (stored goods9) (stored goods6))))
	(preference p0C (always (>= (stored goods16) (stored goods8))))
	(preference p0D (always (>= (stored goods19) (stored goods1))))

	(forall (?t - truck)
	   (preference p4A (always-within 1573.00 (> (loaded goods12 ?t) 0)
			      (= (loaded goods12 ?t) 0))))

	(forall (?t - truck)
	   (preference p4B (always-within 3043.00 (> (loaded goods19 ?t) 0)
			      (= (loaded goods19 ?t) 0))))

	(forall (?t - truck)
	   (preference p4C (always-within 1411.00 (> (loaded goods13 ?t) 0)
			      (= (loaded goods13 ?t) 0))))

	(forall (?t - truck)
	   (preference p4D (always-within 1351.00 (> (loaded goods9 ?t) 0)
			      (= (loaded goods9 ?t) 0))))

	(forall (?t - truck)
	   (preference p3A (sometime (exists (?g - goods) (> (loaded ?g ?t) 0)))))

	(preference p0E (sometime-before (> (stored goods11) 0)
			   (>= (stored goods14) (request goods14))))
	(preference p0F (sometime-before (> (stored goods12) 0)
			   (>= (stored goods7) (request goods7))))
	(preference p0G (sometime-before (> (stored goods15) 0)
			   (>= (stored goods18) (request goods18))))

	(preference p0H (sometime-before (> (stored goods4) 0)
			   (>= (bought goods5) (request goods5))))
	(preference p0I (sometime-before (> (stored goods13) 0)
			   (>= (bought goods3) (request goods3))))
	(preference p0J (sometime-before (> (stored goods17) 0)
