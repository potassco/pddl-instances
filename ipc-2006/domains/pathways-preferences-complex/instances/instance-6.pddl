...
(:goal
	(and
	(preference p0A (>= (+ (available Skp2-cdk2p1-cycA) (available p57-cdk2p1-cycE)) 5))
	(preference p0B (>= (+ (available SP1-p107-gP) (available p57p1-cdk46p1-cycDp1)) 7))
	(preference p0C (>= (+ (available p57-cdk2p1-cycA) (available Raf1-pRbp1-E2F13-DP12p1)) 4))
	(preference p0D (>= (+ (available Raf1-pRbp1-E2F4-DP12) (available HDAC1-p107-E2F4-DP12)) 5))
	(preference p0E (>= (+ (available p57-cdk46p1-cycD) (available p57p1-cdk46p1-cycD)) 7))
	(preference p0F (>= (+ (available cdk2p1-cycE) (available cdk2p1-cycA)) 5))
	(preference p0G (>= (+ (available p57-cdk46p1-cycDp1) (available SP1-p107p1-gP)) 5))
	(preference p0H (>= (+ (available p57-cdk2p1-cycEp1) (available RPA-cycA)) 7))))


(:constraints (and

	(preference p1A (sometime-before (> (available Raf1-pRbp1-E2F4-DP12) 0) (> (available pRbp1-E2F4-DP12) 0)))
	(preference p1B (sometime-before (> (available HDAC1-p107-E2F4-DP12) 0) (> (available p107) 0)))

	(preference p1C (always (= (available SP1-gP) 0)))
	(preference p1D (always (= (available cycA) 0)))

	(preference p1E (sometime (> (available Ecadherin) 0)))
	(preference p1F (sometime-after (> (available Ecadherin) 0) (> (available p107-E2F4-DP12) 0)))
	(preference p1G (sometime (> (available HDAC1-pRb-E2F4-DP12) 0)))
	(preference p1H (sometime-after (> (available HDAC1-pRb-E2F4-DP12) 0) (> (available HDAC1-pRb-E2F13-DP12p1) 0)))
	(preference p1I (sometime (> (available p19ARF) 0)))
	(preference p1J (sometime-after (> (available p19ARF) 0) (> (available Raf1-pRb-E2F13-DP12p1) 0)))
	(preference p1K (sometime (> (available E2F4-DP12) 0)))
	(preference p1L (sometime-after (> (available E2F4-DP12) 0) (> (available pRbp1-E2F13p1-DP12p1) 0)))))
