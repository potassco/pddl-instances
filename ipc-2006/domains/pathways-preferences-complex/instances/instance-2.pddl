...
(:goal
	(and
	(preference p0A (>= (+ (available p107-E2F4-DP12p1-gE2) (available p107-E2F4-DP12p1)) 4))
	(preference p0B (>= (+ (available cycDp1) (available c-Myc-Max)) 3))))


(:constraints (and

	(preference p1A (sometime-before (> (available p107-E2F4-DP12p1-gE2) 0) (> (available p107) 0)))
	(preference p1B (sometime-before (> (available cycDp1) 0) (> (available E2F13p1-DP12-gE2) 0)))
	(preference p1C (sometime-before (> (available c-Myc-Max) 0) (> (available c-Myc) 0)))

))

(:metric minimize (+ (* 6.2 (is-violated p0A))
		     (* 8.8 (is-violated p0B))
		     (* 1 (is-violated p1A))
		     (* 1 (is-violated p1B))
		     (* 1 (is-violated p1C))
