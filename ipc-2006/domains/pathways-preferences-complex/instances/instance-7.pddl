...
(:goal
	(and
	(preference p0A (>= (+ (available PCNA-Gadd45) (available cycA)) 5))
	(preference p0B (>= (+ (available cdc25A) (available p21-cdk2p1-cycE)) 5))
	(preference p0C (>= (+ (available p57-cdk2p1-cycA) (available p27-cdk46p1-cycDp1)) 5))
	(preference p0D (>= (+ (available PCNA-p21-cdk2-cycA) (available p57-cdk2p1-cycE)) 3))
	(preference p0E (>= (+ (available p27-cdk2p1-cycA) (available PCNA-p21-cdk2p1-cycE)) 5))
	(preference p0F (>= (+ (available cdk2-cycE) (available p21-cdk46p1-cycD)) 3))
	(preference p0G (>= (+ (available PCNA-p21-cdk2p1-cycEp1) (available c-Myc-Max)) 2))
	(preference p0H (>= (+ (available p27-cdk2p1-cycEp1) (available pRbp1-Jun-c-Fos)) 5))
	(preference p0I (>= (+ (available Mdm2-E2F13-DP12) (available p57-cdk2-cycE)) 3))
	(preference p0J (>= (+ (available p21-cdk2p1-cycA) (available PCNA-p21-cdk2-cycEp1)) 5))
	(preference p0K (>= (+ (available p21-cdk2-cycA) (available p21-cdk2-cycE)) 4))))


(:constraints (and

	(preference p1A (sometime-before (> (available PCNA-Gadd45) 0) (> (available Gadd45) 0)))
	(preference p1B (sometime-before (> (available p27-cdk46p1-cycDp1) 0) (> (available cdk46p1-cycDp1) 0)))
	(preference p1C (sometime-before (> (available p27-cdk2p1-cycEp1) 0) (> (available E2F5-DP12) 0)))
	(preference p1D (sometime-before (> (available Mdm2-E2F13-DP12) 0) (> (available Mdm2) 0)))

	(preference p1E (always (= (available E2F5-DP12-gE2) 0)))
	(preference p1F (always (= (available cycA) 0)))
	(preference p1G (always (= (available cycEp1) 0)))
	(preference p1H (always (= (available p21) 0)))

	(preference p1I (sometime (> (available PCNA-cycD) 0)))
	(preference p1J (sometime-after (> (available PCNA-cycD) 0) (> (available p130-E2F5-DP12p1-gE2) 0)))
	(preference p1K (sometime (> (available p53-DP12) 0)))
	(preference p1L (sometime-after (> (available p53-DP12) 0) (> (available PCNA-p21-cdk46p1-cycD) 0)))
	(preference p1M (sometime (> (available HBP1-p130) 0)))
	(preference p1N (sometime-after (> (available HBP1-p130) 0) (> (available c-Abl-pRbp1p2) 0)))
	(preference p1O (sometime (> (available pRbp1p2) 0)))
	(preference p1P (sometime-after (> (available pRbp1p2) 0) (> (available SP1-p107) 0)))
	(preference p1Q (sometime (> (available Skp2-Skp1-cdk2p1-cycA) 0)))
	(preference p1R (sometime-after (> (available Skp2-Skp1-cdk2p1-cycA) 0) (> (available p21-cdk2-cycEp1) 0)))
	(preference p1S (sometime (> (available pol) 0)))
	(preference p1T (sometime-after (> (available pol) 0) (> (available c-Abl-pRbp1) 0)))
	(preference p1U (sometime (> (available Skp2-cdk2p1-cycA) 0)))
	(preference p1V (sometime-after (> (available Skp2-cdk2p1-cycA) 0) (> (available cycDp1) 0)))))
