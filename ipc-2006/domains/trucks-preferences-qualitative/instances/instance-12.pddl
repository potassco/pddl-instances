...
(:goal (and 
	...
	(preference p5A (delivered package2 l1 t4))
	(at-destination package3 l3)
	(preference p5B (delivered package3 l3 t4))
	(at-destination package4 l2)
	(preference p5C (delivered package4 l2 t8))
	(at-destination package5 l2)
	(preference p5D (delivered package5 l2 t8))
	(at-destination package6 l3)
	(preference p5E (delivered package6 l3 t8))
	(at-destination package7 l3)
	(preference p5F (delivered package7 l3 t12))
	(at-destination package8 l3)
	(preference p5G (delivered package8 l3 t12))
	(at-destination package9 l2)
	(preference p5H (delivered package9 l2 t12))
	(at-destination package10 l3)
	(preference p5I (delivered package10 l3 t16))
	(at-destination package11 l3)
	(preference p5J (delivered package11 l3 t16))
	(at-destination package12 l3)
	(preference p5K (delivered package12 l3 t16))
	(at-destination package13 l3)
	(at-destination package14 l1)
	(preference p5L (delivered package14 l1 t20))))
...
(:constraints (and
	...
	(preference p2A (sometime-before (delivered package2 l1 t4)
					 (at-destination package1 l1)))
	(preference p2B (sometime-before (delivered package6 l3 t8)
					 (delivered package5 l2 t8)))
	(preference p2C (sometime-before (delivered package9 l2 t12)
					 (delivered package8 l3 t12)))
	(preference p2D (sometime-before (delivered package11 l3 t16)
