...
(:goal (and 
	...
	(preference p5D (delivered package5 l3 t8))
...
(:constraints (and
	...
	(preference p2A (sometime-before (delivered package5 l3 t8)
					 (delivered package4 l3 t8)))
	(preference p2B (sometime-before (at-destination package6 l4)
