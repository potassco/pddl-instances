...
(:goal (and 
	...
	(preference p4A (delivered package6 l3 t9))
	(at-destination package7 l2)
	(at-destination package8 l3)
	(preference p4B (delivered package8 l3 t12))))
...
(:constraints (and
	...
	(preference p1B (sometime-before (at-destination package4 l3)
					 (at-destination package3 l4)))
	(preference p1C (sometime-before (delivered package6 l3 t9)
					 (at-destination package5 l3)))
	(preference p1D (sometime-before (delivered package8 l3 t12)
					 (at-destination package7 l2)))
