...
(:goal (and 
	...
	(preference p5B (delivered package2 l2 t4))
	(at-destination package3 l1)
	(preference p5C (delivered package3 l1 t4))
	(at-destination package4 l1)
	(preference p5D (delivered package4 l1 t8))
	(at-destination package5 l1)
	(preference p5E (delivered package5 l1 t8))
	(at-destination package6 l2)
	(preference p5F (delivered package6 l2 t8))
	(at-destination package7 l4)
	(preference p5G (delivered package7 l4 t12))
	(at-destination package8 l2)
	(preference p5H (delivered package8 l2 t12))
...
(:constraints (and
	...
	(preference p2A (sometime-before (delivered package8 l2 t12)
					 (delivered package7 l4 t12)))
	(preference p2B (sometime-before (at-destination package11 l1)
