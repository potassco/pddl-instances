...
(:goal (and 
	...
	(preference p5A (delivered package4 l1 t8))
	(at-destination package5 l1)
	(preference p5B (delivered package5 l1 t8))
	(at-destination package6 l2)
	(preference p5C (delivered package6 l2 t8))
	(at-destination package7 l4)
	(preference p5D (delivered package7 l4 t12))
	(at-destination package8 l1)
	(preference p5E (delivered package8 l1 t12))
	(at-destination package9 l3)
	(preference p5F (delivered package9 l3 t12))
...
(:constraints (and
	...
	(preference p2A (sometime-before (at-destination package2 l2)
					 (at-destination package1 l2)))
	(preference p2B (sometime-before (delivered package8 l1 t12)
