...
(:init
	...
	(= (data Phenomenon25 thermograph2) 2)
	(= (data Star26 thermograph2) 58)
	(= (data Planet27 thermograph2) 59)
	(= (data Planet28 thermograph2) 194)
	(= (data Phenomenon29 thermograph2) 2)
	...
	(= (data Phenomenon25 thermograph0) 62)
	(= (data Star26 thermograph0) 55)
	(= (data Planet27 thermograph0) 172)
	(= (data Planet28 thermograph0) 21)
	(= (data Phenomenon29 thermograph0) 128)
	...
	(= (data Phenomenon25 thermograph4) 26)
	(= (data Star26 thermograph4) 190)
	(= (data Planet27 thermograph4) 1)
	(= (data Planet28 thermograph4) 174)
	(= (data Phenomenon29 thermograph4) 73)
	...
	(= (data Phenomenon25 image1) 87)
	(= (data Star26 image1) 40)
	(= (data Planet27 image1) 27)
	(= (data Planet28 image1) 121)
	(= (data Phenomenon29 image1) 87)
	...
	(= (data Phenomenon25 thermograph3) 130)
	(= (data Star26 thermograph3) 132)
	(= (data Planet27 thermograph3) 37)
	(= (data Planet28 thermograph3) 22)
	(= (data Phenomenon29 thermograph3) 200)
	...
	(= (slew_time Phenomenon25 Star0) 70.14)
	(= (slew_time Star0 Phenomenon25) 70.14)
	(= (slew_time Phenomenon25 Star1) 28.13)
	(= (slew_time Star1 Phenomenon25) 28.13)
	(= (slew_time Phenomenon25 GroundStation2) 77.05)
	(= (slew_time GroundStation2 Phenomenon25) 77.05)
	(= (slew_time Phenomenon25 Star3) 15.78)
	(= (slew_time Star3 Phenomenon25) 15.78)
	(= (slew_time Phenomenon25 Star4) 17.88)
	(= (slew_time Star4 Phenomenon25) 17.88)
	(= (slew_time Phenomenon25 Phenomenon5) 69.12)
	(= (slew_time Phenomenon5 Phenomenon25) 69.12)
	(= (slew_time Phenomenon25 Planet6) 84.5)
	(= (slew_time Planet6 Phenomenon25) 84.5)
	(= (slew_time Phenomenon25 Planet7) 3.558)
	(= (slew_time Planet7 Phenomenon25) 3.558)
	(= (slew_time Phenomenon25 Star8) 71.47)
	(= (slew_time Star8 Phenomenon25) 71.47)
	(= (slew_time Phenomenon25 Star9) 46.95)
	(= (slew_time Star9 Phenomenon25) 46.95)
	(= (slew_time Phenomenon25 Star10) 76.44)
	(= (slew_time Star10 Phenomenon25) 76.44)
	(= (slew_time Phenomenon25 Planet11) 66.42)
	(= (slew_time Planet11 Phenomenon25) 66.42)
	(= (slew_time Phenomenon25 Phenomenon12) 13.58)
	(= (slew_time Phenomenon12 Phenomenon25) 13.58)
	(= (slew_time Phenomenon25 Phenomenon13) 35.09)
	(= (slew_time Phenomenon13 Phenomenon25) 35.09)
	(= (slew_time Phenomenon25 Planet14) 2.212)
	(= (slew_time Planet14 Phenomenon25) 2.212)
	(= (slew_time Phenomenon25 Star15) 33)
	(= (slew_time Star15 Phenomenon25) 33)
	(= (slew_time Phenomenon25 Phenomenon16) 47.05)
	(= (slew_time Phenomenon16 Phenomenon25) 47.05)
	(= (slew_time Phenomenon25 Phenomenon17) 29.67)
	(= (slew_time Phenomenon17 Phenomenon25) 29.67)
	(= (slew_time Phenomenon25 Phenomenon18) 52.29)
	(= (slew_time Phenomenon18 Phenomenon25) 52.29)
	(= (slew_time Phenomenon25 Planet19) 76.62)
	(= (slew_time Planet19 Phenomenon25) 76.62)
	(= (slew_time Phenomenon25 Planet20) 37.16)
	(= (slew_time Planet20 Phenomenon25) 37.16)
	(= (slew_time Phenomenon25 Phenomenon21) 13.94)
	(= (slew_time Phenomenon21 Phenomenon25) 13.94)
	(= (slew_time Phenomenon25 Star22) 63.09)
	(= (slew_time Star22 Phenomenon25) 63.09)
	(= (slew_time Phenomenon25 Planet23) 64.61)
	(= (slew_time Planet23 Phenomenon25) 64.61)
	(= (slew_time Phenomenon25 Phenomenon24) 47.67)
	(= (slew_time Phenomenon24 Phenomenon25) 47.67)
	(= (slew_time Star26 Star0) 37.78)
	(= (slew_time Star0 Star26) 37.78)
	(= (slew_time Star26 Star1) 0.5682)
	(= (slew_time Star1 Star26) 0.5682)
	(= (slew_time Star26 GroundStation2) 22.55)
	(= (slew_time GroundStation2 Star26) 22.55)
	(= (slew_time Star26 Star3) 80.45)
	(= (slew_time Star3 Star26) 80.45)
	(= (slew_time Star26 Star4) 47.99)
	(= (slew_time Star4 Star26) 47.99)
	(= (slew_time Star26 Phenomenon5) 75.07)
	(= (slew_time Phenomenon5 Star26) 75.07)
	(= (slew_time Star26 Planet6) 27.85)
	(= (slew_time Planet6 Star26) 27.85)
	(= (slew_time Star26 Planet7) 4.222)
	(= (slew_time Planet7 Star26) 4.222)
	(= (slew_time Star26 Star8) 16.09)
	(= (slew_time Star8 Star26) 16.09)
	(= (slew_time Star26 Star9) 41.58)
	(= (slew_time Star9 Star26) 41.58)
	(= (slew_time Star26 Star10) 34.39)
	(= (slew_time Star10 Star26) 34.39)
	(= (slew_time Star26 Planet11) 56.75)
	(= (slew_time Planet11 Star26) 56.75)
	(= (slew_time Star26 Phenomenon12) 0.7687)
	(= (slew_time Phenomenon12 Star26) 0.7687)
	(= (slew_time Star26 Phenomenon13) 71.05)
	(= (slew_time Phenomenon13 Star26) 71.05)
	(= (slew_time Star26 Planet14) 36)
	(= (slew_time Planet14 Star26) 36)
	(= (slew_time Star26 Star15) 8.491)
	(= (slew_time Star15 Star26) 8.491)
	(= (slew_time Star26 Phenomenon16) 11.7)
	(= (slew_time Phenomenon16 Star26) 11.7)
	(= (slew_time Star26 Phenomenon17) 11.91)
	(= (slew_time Phenomenon17 Star26) 11.91)
	(= (slew_time Star26 Phenomenon18) 12.23)
	(= (slew_time Phenomenon18 Star26) 12.23)
	(= (slew_time Star26 Planet19) 9.303)
	(= (slew_time Planet19 Star26) 9.303)
	(= (slew_time Star26 Planet20) 72.65)
	(= (slew_time Planet20 Star26) 72.65)
	(= (slew_time Star26 Phenomenon21) 46.07)
	(= (slew_time Phenomenon21 Star26) 46.07)
	(= (slew_time Star26 Star22) 5.196)
	(= (slew_time Star22 Star26) 5.196)
	(= (slew_time Star26 Planet23) 6.687)
	(= (slew_time Planet23 Star26) 6.687)
	(= (slew_time Star26 Phenomenon24) 55.13)
	(= (slew_time Phenomenon24 Star26) 55.13)
	(= (slew_time Star26 Phenomenon25) 35.37)
	(= (slew_time Phenomenon25 Star26) 35.37)
	(= (slew_time Planet27 Star0) 28.5)
	(= (slew_time Star0 Planet27) 28.5)
	(= (slew_time Planet27 Star1) 15.79)
	(= (slew_time Star1 Planet27) 15.79)
	(= (slew_time Planet27 GroundStation2) 15.25)
	(= (slew_time GroundStation2 Planet27) 15.25)
	(= (slew_time Planet27 Star3) 8.351)
	(= (slew_time Star3 Planet27) 8.351)
	(= (slew_time Planet27 Star4) 64.06)
	(= (slew_time Star4 Planet27) 64.06)
	(= (slew_time Planet27 Phenomenon5) 4.464)
	(= (slew_time Phenomenon5 Planet27) 4.464)
	(= (slew_time Planet27 Planet6) 1.956)
	(= (slew_time Planet6 Planet27) 1.956)
	(= (slew_time Planet27 Planet7) 74.48)
	(= (slew_time Planet7 Planet27) 74.48)
	(= (slew_time Planet27 Star8) 2.718)
	(= (slew_time Star8 Planet27) 2.718)
	(= (slew_time Planet27 Star9) 1.067)
	(= (slew_time Star9 Planet27) 1.067)
	(= (slew_time Planet27 Star10) 20.75)
	(= (slew_time Star10 Planet27) 20.75)
	(= (slew_time Planet27 Planet11) 70.73)
	(= (slew_time Planet11 Planet27) 70.73)
	(= (slew_time Planet27 Phenomenon12) 18.08)
	(= (slew_time Phenomenon12 Planet27) 18.08)
	(= (slew_time Planet27 Phenomenon13) 6.433)
	(= (slew_time Phenomenon13 Planet27) 6.433)
	(= (slew_time Planet27 Planet14) 54.68)
	(= (slew_time Planet14 Planet27) 54.68)
	(= (slew_time Planet27 Star15) 54.37)
	(= (slew_time Star15 Planet27) 54.37)
	(= (slew_time Planet27 Phenomenon16) 50.34)
	(= (slew_time Phenomenon16 Planet27) 50.34)
	(= (slew_time Planet27 Phenomenon17) 5.607)
	(= (slew_time Phenomenon17 Planet27) 5.607)
	(= (slew_time Planet27 Phenomenon18) 3.198)
	(= (slew_time Phenomenon18 Planet27) 3.198)
	(= (slew_time Planet27 Planet19) 12.2)
	(= (slew_time Planet19 Planet27) 12.2)
	(= (slew_time Planet27 Planet20) 53.14)
	(= (slew_time Planet20 Planet27) 53.14)
	(= (slew_time Planet27 Phenomenon21) 46.93)
	(= (slew_time Phenomenon21 Planet27) 46.93)
	(= (slew_time Planet27 Star22) 20.64)
	(= (slew_time Star22 Planet27) 20.64)
	(= (slew_time Planet27 Planet23) 1.099)
	(= (slew_time Planet23 Planet27) 1.099)
	(= (slew_time Planet27 Phenomenon24) 6.802)
	(= (slew_time Phenomenon24 Planet27) 6.802)
	(= (slew_time Planet27 Phenomenon25) 33.06)
	(= (slew_time Phenomenon25 Planet27) 33.06)
	(= (slew_time Planet27 Star26) 17.51)
	(= (slew_time Star26 Planet27) 17.51)
	(= (slew_time Planet28 Star0) 61.2)
	(= (slew_time Star0 Planet28) 61.2)
	(= (slew_time Planet28 Star1) 15.81)
	(= (slew_time Star1 Planet28) 15.81)
	(= (slew_time Planet28 GroundStation2) 51.21)
	(= (slew_time GroundStation2 Planet28) 51.21)
	(= (slew_time Planet28 Star3) 91.5)
	(= (slew_time Star3 Planet28) 91.5)
	(= (slew_time Planet28 Star4) 66.21)
	(= (slew_time Star4 Planet28) 66.21)
	(= (slew_time Planet28 Phenomenon5) 65.4)
	(= (slew_time Phenomenon5 Planet28) 65.4)
	(= (slew_time Planet28 Planet6) 45.81)
	(= (slew_time Planet6 Planet28) 45.81)
	(= (slew_time Planet28 Planet7) 20.21)
	(= (slew_time Planet7 Planet28) 20.21)
	(= (slew_time Planet28 Star8) 6.378)
	(= (slew_time Star8 Planet28) 6.378)
	(= (slew_time Planet28 Star9) 30.66)
	(= (slew_time Star9 Planet28) 30.66)
	(= (slew_time Planet28 Star10) 64.45)
	(= (slew_time Star10 Planet28) 64.45)
	(= (slew_time Planet28 Planet11) 51.89)
	(= (slew_time Planet11 Planet28) 51.89)
	(= (slew_time Planet28 Phenomenon12) 2.334)
	(= (slew_time Phenomenon12 Planet28) 2.334)
	(= (slew_time Planet28 Phenomenon13) 7.527)
	(= (slew_time Phenomenon13 Planet28) 7.527)
	(= (slew_time Planet28 Planet14) 7.672)
	(= (slew_time Planet14 Planet28) 7.672)
	(= (slew_time Planet28 Star15) 8.107)
	(= (slew_time Star15 Planet28) 8.107)
	(= (slew_time Planet28 Phenomenon16) 26.28)
	(= (slew_time Phenomenon16 Planet28) 26.28)
	(= (slew_time Planet28 Phenomenon17) 50.17)
	(= (slew_time Phenomenon17 Planet28) 50.17)
	(= (slew_time Planet28 Phenomenon18) 20.77)
	(= (slew_time Phenomenon18 Planet28) 20.77)
	(= (slew_time Planet28 Planet19) 43.39)
	(= (slew_time Planet19 Planet28) 43.39)
	(= (slew_time Planet28 Planet20) 16.5)
	(= (slew_time Planet20 Planet28) 16.5)
	(= (slew_time Planet28 Phenomenon21) 8.289)
	(= (slew_time Phenomenon21 Planet28) 8.289)
	(= (slew_time Planet28 Star22) 4.385)
	(= (slew_time Star22 Planet28) 4.385)
	(= (slew_time Planet28 Planet23) 6.966)
	(= (slew_time Planet23 Planet28) 6.966)
	(= (slew_time Planet28 Phenomenon24) 46.54)
	(= (slew_time Phenomenon24 Planet28) 46.54)
	(= (slew_time Planet28 Phenomenon25) 10.41)
	(= (slew_time Phenomenon25 Planet28) 10.41)
	(= (slew_time Planet28 Star26) 7.974)
	(= (slew_time Star26 Planet28) 7.974)
	(= (slew_time Planet28 Planet27) 17.07)
	(= (slew_time Planet27 Planet28) 17.07)
	(= (slew_time Phenomenon29 Star0) 64.33)
	(= (slew_time Star0 Phenomenon29) 64.33)
	(= (slew_time Phenomenon29 Star1) 8.25)
	(= (slew_time Star1 Phenomenon29) 8.25)
	(= (slew_time Phenomenon29 GroundStation2) 7.665)
	(= (slew_time GroundStation2 Phenomenon29) 7.665)
	(= (slew_time Phenomenon29 Star3) 22.5)
	(= (slew_time Star3 Phenomenon29) 22.5)
	(= (slew_time Phenomenon29 Star4) 87.02)
	(= (slew_time Star4 Phenomenon29) 87.02)
	(= (slew_time Phenomenon29 Phenomenon5) 3.256)
	(= (slew_time Phenomenon5 Phenomenon29) 3.256)
	(= (slew_time Phenomenon29 Planet6) 0.1638)
	(= (slew_time Planet6 Phenomenon29) 0.1638)
	(= (slew_time Phenomenon29 Planet7) 37.94)
	(= (slew_time Planet7 Phenomenon29) 37.94)
	(= (slew_time Phenomenon29 Star8) 3.605)
	(= (slew_time Star8 Phenomenon29) 3.605)
	(= (slew_time Phenomenon29 Star9) 15.56)
	(= (slew_time Star9 Phenomenon29) 15.56)
	(= (slew_time Phenomenon29 Star10) 38.79)
	(= (slew_time Star10 Phenomenon29) 38.79)
	(= (slew_time Phenomenon29 Planet11) 5.096)
	(= (slew_time Planet11 Phenomenon29) 5.096)
	(= (slew_time Phenomenon29 Phenomenon12) 23.37)
	(= (slew_time Phenomenon12 Phenomenon29) 23.37)
	(= (slew_time Phenomenon29 Phenomenon13) 36.11)
	(= (slew_time Phenomenon13 Phenomenon29) 36.11)
	(= (slew_time Phenomenon29 Planet14) 13.07)
	(= (slew_time Planet14 Phenomenon29) 13.07)
	(= (slew_time Phenomenon29 Star15) 89.12)
	(= (slew_time Star15 Phenomenon29) 89.12)
	(= (slew_time Phenomenon29 Phenomenon16) 9.065)
	(= (slew_time Phenomenon16 Phenomenon29) 9.065)
	(= (slew_time Phenomenon29 Phenomenon17) 57.26)
	(= (slew_time Phenomenon17 Phenomenon29) 57.26)
	(= (slew_time Phenomenon29 Phenomenon18) 81.36)
	(= (slew_time Phenomenon18 Phenomenon29) 81.36)
	(= (slew_time Phenomenon29 Planet19) 2.529)
	(= (slew_time Planet19 Phenomenon29) 2.529)
	(= (slew_time Phenomenon29 Planet20) 72.96)
	(= (slew_time Planet20 Phenomenon29) 72.96)
	(= (slew_time Phenomenon29 Phenomenon21) 83.9)
	(= (slew_time Phenomenon21 Phenomenon29) 83.9)
	(= (slew_time Phenomenon29 Star22) 14.75)
	(= (slew_time Star22 Phenomenon29) 14.75)
	(= (slew_time Phenomenon29 Planet23) 50.41)
	(= (slew_time Planet23 Phenomenon29) 50.41)
	(= (slew_time Phenomenon29 Phenomenon24) 9.894)
	(= (slew_time Phenomenon24 Phenomenon29) 9.894)
	(= (slew_time Phenomenon29 Phenomenon25) 36.56)
	(= (slew_time Phenomenon25 Phenomenon29) 36.56)
	(= (slew_time Phenomenon29 Star26) 71.22)
	(= (slew_time Star26 Phenomenon29) 71.22)
	(= (slew_time Phenomenon29 Planet27) 37.13)
	(= (slew_time Planet27 Phenomenon29) 37.13)
	(= (slew_time Phenomenon29 Planet28) 58.69)
	(= (slew_time Planet28 Phenomenon29) 58.69)
	(= (data-stored) 0)
	(= (fuel-used) 0)
)
(:goal (and
