...
(:durative-action idle_11
 ...
 :effect    (and
                 (at end (idled_11))
                 (at end (not (landed_10)))
            )
)
(:durative-action land_11
 :parameters ()
 :duration (= ?duration 30)
 :condition (and
                 (over all (idled_11))
...
(:durative-action idle_12
 ...
 :effect    (and
                 (at end (idled_12))
                 (at end (not (landed_11)))
            )
)
(:durative-action land_12
 :parameters ()
 :duration (= ?duration 30)
 :condition (and
                 (over all (idled_12))
