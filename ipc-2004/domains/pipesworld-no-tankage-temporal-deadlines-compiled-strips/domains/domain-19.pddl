...
(:constants lco gasoleo rat-a oca1 oc1b - product 
	 B7 B12 B3 B2 B5 B15 - batch-atom)
(:predicates
...
(:durative-action timedliteral2
 ...
 :effect
   (and (at end (P2)) (at end (not (P1))) (at end (not (deliverable B15)))))
...
(:durative-action timedliteral3
 ...
 :effect
   (and (at end (P3)) (at end (not (P2))) (at end (not (deliverable B7)))))
...
(:durative-action timedliteral4
 ...
 :effect
   (and (at end (P4)) (at end (not (P3))) (at end (not (deliverable B12))) (at end (not (deliverable B3)))))
