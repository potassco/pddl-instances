...
(:constants lco gasoleo rat-a oca1 oc1b - product 
	 B1 B4 B2 B13 B11 - batch-atom)
(:predicates

  (N) (NN) (PN) (P0) (P1) (P2) (P3) (P4) (P5)
...
(:durative-action timedliteral1
 ...
 :effect
   (and (at end (P1)) (at end (not (P0))) (at end (not (deliverable B13)))))
...
(:durative-action timedliteral2
 ...
 :effect
   (and (at end (P2)) (at end (not (P1))) (at end (not (deliverable B2)))))

(:durative-action timedliteral3
 :parameters ()
 :duration (= ?duration 7.36)
 :condition
...
(:durative-action timedliteral5
 ...
 :effect
   (and (at end (P5)) (at end (not (P4))) (at end (not (deliverable B4)))))
