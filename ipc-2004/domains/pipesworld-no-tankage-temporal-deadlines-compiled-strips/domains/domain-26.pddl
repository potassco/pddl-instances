...
(:constants lco gasoleo rat-a oca1 oc1b - product 
	 B9 B17 B3 B1 B4 B11 B6 - batch-atom)
(:predicates
...
(:durative-action timedliteral2
 ...
 :effect
   (and (at end (P2)) (at end (not (P1))) (at end (not (deliverable B17)))))
...
(:durative-action timedliteral3
 ...
 :effect
   (and (at end (P3)) (at end (not (P2))) (at end (not (deliverable B9))) (at end (not (deliverable B3))) (at end (not (deliverable B11)))))
...
(:durative-action timedliteral5
 ...
 :effect
   (and (at end (P5)) (at end (not (P4))) (at end (not (deliverable B6)))))
