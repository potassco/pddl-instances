...
(:constants lco gasoleo rat-a oca1 oc1b - product 
	 B9 B0 B3 B2 B11 B5 B15 - batch-atom)
(:predicates
...
(:durative-action timedliteral4
 :parameters ()
 :duration (= ?duration 6.01)
 :condition
   (and (over all (P3)) (over all (PN)))
 :effect
   (and (at end (P4)) (at end (not (P3))) (at end (not (deliverable B15)))))
...
(:durative-action timedliteral6
 ...
 :effect
   (and (at end (P6)) (at end (not (P5))) (at end (not (deliverable B11)))))
