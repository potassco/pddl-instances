...
(:constants lco gasoleo rat-a oca1 oc1b - product 
	 B17 B3 B1 B4 B11 B6 - batch-atom)
(:predicates
...
(:durative-action timedliteral1
 :parameters ()
 :duration (= ?duration 12.14)
 :condition
   (and (over all (P0)) (over all (PN)))
 :effect
   (and (at end (P1)) (at end (not (P0))) (at end (not (deliverable B17)))))
...
(:durative-action timedliteral3
 ...
 :effect
   (and (at end (P3)) (at end (not (P2))) (at end (not (deliverable B11))) (at end (not (deliverable B6)))))
...
(:durative-action timedliteral4
 ...
 :effect
   (and (at end (P4)) (at end (not (P3))) (at end (not (deliverable B3))) (at end (not (deliverable B4)))))
