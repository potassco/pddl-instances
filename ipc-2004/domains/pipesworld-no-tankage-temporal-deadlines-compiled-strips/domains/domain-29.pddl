...
(:constants lco gasoleo rat-a oca1 oc1b - product 
	 B7 B1 B16 B2 - batch-atom)
(:predicates

  (N) (NN) (PN) (P0) (P1) (P2) (P3) (P4)
...
(:durative-action timedliteral1
 :parameters ()
 :duration (= ?duration 7.10)
 :condition
   (and (over all (P0)) (over all (PN)))
 :effect
   (and (at end (P1)) (at end (not (P0))) (at end (not (deliverable B1)))))
...
(:durative-action timedliteral4
 ...
 :effect
   (and (at end (P4)) (at end (not (P3))) (at end (not (deliverable B16)))))
