...
(:constants lco gasoleo rat-a oca1 oc1b - product 
	 B10 B0 B1 B14 B11 B6 B15 - batch-atom)
(:predicates
...
(:durative-action timedliteral1
 ...
 :effect
   (and (at end (P1)) (at end (not (P0))) (at end (not (deliverable B10)))))
...
(:durative-action timedliteral3
 ...
 :effect
   (and (at end (P3)) (at end (not (P2))) (at end (not (deliverable B14)))))
...
(:durative-action timedliteral4
 ...
 :effect
   (and (at end (P4)) (at end (not (P3))) (at end (not (deliverable B6)))))
...
(:durative-action timedliteral5
 ...
 :effect
   (and (at end (P5)) (at end (not (P4))) (at end (not (deliverable B15)))))
...
(:durative-action timedliteral6
 ...
 :effect
   (and (at end (P6)) (at end (not (P5))) (at end (not (deliverable B0)))))
...
(:durative-action timedliteral7
 ...
 :effect
   (and (at end (P7)) (at end (not (P6))) (at end (not (deliverable B11)))))
