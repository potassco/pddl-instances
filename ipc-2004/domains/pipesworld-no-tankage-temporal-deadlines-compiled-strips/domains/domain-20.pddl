...
(:constants lco gasoleo rat-a oca1 oc1b - product 
	 B17 B6 B15 B7 B12 B3 B2 B5 - batch-atom)
(:predicates
...
(:durative-action timedliteral1
 ...
 :effect
   (and (at end (P1)) (at end (not (P0))) (at end (not (deliverable B7)))))
...
(:durative-action timedliteral2
 ...
 :effect
   (and (at end (P2)) (at end (not (P1))) (at end (not (deliverable B3)))))
...
(:durative-action timedliteral3
 ...
 :effect
   (and (at end (P3)) (at end (not (P2))) (at end (not (deliverable B2)))))
...
(:durative-action timedliteral4
 ...
 :effect
   (and (at end (P4)) (at end (not (P3))) (at end (not (deliverable B12)))))
...
(:durative-action timedliteral5
 ...
 :effect
   (and (at end (P5)) (at end (not (P4))) (at end (not (deliverable B5)))))
...
(:durative-action timedliteral6
 ...
 :effect
   (and (at end (P6)) (at end (not (P5))) (at end (not (deliverable B15)))))
...
(:durative-action timedliteral7
 ...
 :effect
   (and (at end (P7)) (at end (not (P6))) (at end (not (deliverable B17)))))
...
(:durative-action timedliteral8
 ...
 :effect
   (and (at end (P8)) (at end (not (P7))) (at end (not (deliverable B6)))))
