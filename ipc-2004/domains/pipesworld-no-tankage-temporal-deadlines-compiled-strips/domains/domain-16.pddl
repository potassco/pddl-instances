...
(:constants lco gasoleo rat-a oca1 oc1b - product 
	 B7 B12 B3 B1 B2 B8 - batch-atom)
(:predicates

  (N) (NN) (PN) (P0) (P1) (P2) (P3) (P4) (P5) (P6)
...
(:durative-action timedliteral1
 :parameters ()
 :duration (= ?duration 16.13)
 :condition
   (and (over all (P0)) (over all (PN)))
 :effect
   (and (at end (P1)) (at end (not (P0))) (at end (not (deliverable B8)))))
...
(:durative-action timedliteral3
 ...
 :effect
   (and (at end (P3)) (at end (not (P2))) (at end (not (deliverable B12)))))
...
(:durative-action timedliteral4
 ...
 :effect
   (and (at end (P4)) (at end (not (P3))) (at end (not (deliverable B1)))))
...
(:durative-action timedliteral5
 ...
 :effect
   (and (at end (P5)) (at end (not (P4))) (at end (not (deliverable B7)))))
...
(:durative-action timedliteral6
 ...
 :effect
   (and (at end (P6)) (at end (not (P5))) (at end (not (deliverable B2)))))
