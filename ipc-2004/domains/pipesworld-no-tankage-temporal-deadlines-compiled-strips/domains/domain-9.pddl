...
(:constants lco gasoleo rat-a oca1 oc1b - product 
	 B10 B12 B4 B8 B6 B5 - batch-atom)
(:predicates
...
(:durative-action timedliteral2
 ...
 :effect
   (and (at end (P2)) (at end (not (P1))) (at end (not (deliverable B4)))))
...
(:durative-action timedliteral5
 :parameters ()
 :duration (= ?duration 8.02)
 :condition
   (and (over all (P4)) (over all (PN)))
 :effect
   (and (at end (P5)) (at end (not (P4))) (at end (not (deliverable B10)))))
...
(:durative-action timedliteral6
 ...
 :effect
   (and (at end (P6)) (at end (not (P5))) (at end (not (deliverable B8)))))
