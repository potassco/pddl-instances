...
(:durative-action timedliteral1
 ...
 :effect
   (and (at end (P1)) (at end (not (P0))) (at end (not (deliverable B6)))))
...
(:durative-action timedliteral2
 ...
 :effect
   (and (at end (P2)) (at end (not (P1))) (at end (not (deliverable B5)))))
...
(:durative-action timedliteral4
 ...
 :effect
   (and (at end (P4)) (at end (not (P3))) (at end (not (deliverable B7)))))
