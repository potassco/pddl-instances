...
(:durative-action timedliteral11
 ...
 :effect
	...
	(at end (visible antenna10 satellite3))
))
...
(:durative-action timedliteral22
 ...
 :effect
	...
	(at end (visible antenna19 satellite8))
	(at end (visible antenna19 satellite7))
	(at end (visible antenna19 satellite2))
...
(:durative-action timedliteral23
 ...
 :effect
	...
	(at end (visible antenna20 satellite3))
	(at end (visible antenna20 satellite5))
	(at end (visible antenna20 satellite0))
...
(:durative-action timedliteral26
 ...
 :effect
	...
	(at end (visible antenna21 satellite6))
...
(:durative-action timedliteral27
 ...
 :effect
	...
	(at end (visible antenna22 satellite4))
...
(:durative-action timedliteral33
 ...
 :effect
	...
	(at end (visible antenna24 satellite3))
	(at end (visible antenna24 satellite9))
))
...
(:durative-action timedliteral38
 ...
 :effect
	...
	(at end (visible antenna25 satellite6))
	(at end (visible antenna25 satellite3))
	(at end (visible antenna25 satellite9))
...
(:durative-action timedliteral43
 ...
 :effect
	...
	(at end (visible antenna26 satellite9))
	(at end (visible antenna26 satellite8))
	(at end (visible antenna26 satellite5))
))
...
(:durative-action timedliteral48
 ...
 :effect
	...
	(at end (not (visible antenna10 satellite3)))
))
...
(:durative-action timedliteral64
 ...
 :effect
	...
	(at end (not (visible antenna19 satellite8)))
	(at end (not (visible antenna19 satellite7)))
	(at end (not (visible antenna19 satellite2)))
...
(:durative-action timedliteral65
 ...
 :effect
	...
	(at end (not (visible antenna20 satellite3)))
	(at end (not (visible antenna20 satellite5)))
	(at end (not (visible antenna20 satellite0)))
...
(:durative-action timedliteral67
 ...
 :effect
	...
	(at end (not (visible antenna21 satellite6)))
...
(:durative-action timedliteral68
 ...
 :effect
	...
	(at end (not (visible antenna22 satellite4)))
...
(:durative-action timedliteral72
 ...
 :effect
	...
	(at end (not (visible antenna24 satellite3)))
	(at end (not (visible antenna24 satellite9)))
))
...
(:durative-action timedliteral75
 ...
 :effect
	...
	(at end (not (visible antenna25 satellite6)))
	(at end (not (visible antenna25 satellite3)))
	(at end (not (visible antenna25 satellite9)))
...
(:durative-action timedliteral78
 ...
 :effect
	...
	(at end (not (visible antenna26 satellite9)))
	(at end (not (visible antenna26 satellite8)))
	(at end (not (visible antenna26 satellite5)))
))
