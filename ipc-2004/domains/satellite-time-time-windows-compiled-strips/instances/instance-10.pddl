...
(:init
	...
	(= (slew_time Star15 Star16) 1.868)
        ...
        (= (send_time phenomenon8 image4) 17.45)
        (= (send_time star12 image4) 19.08)
        (= (send_time star6 infrared3) 15.23)
        (= (send_time star7 image4) 19.79)
        (= (send_time phenomenon13 image4) 7.24)
        (= (send_time star15 spectrograph1) 12.20)
        (= (send_time star16 image2) 17.62)
        (= (send_time phenomenon14 spectrograph1) 13.86)

        (at 53.00 (visible antenna0 satellite1))
        (at 133.04 (not (visible antenna0 satellite1)))
        (at 53.00 (visible antenna0 satellite0))
        (at 133.04 (not (visible antenna0 satellite0)))
        (at 53.00 (visible antenna0 satellite4))
        (at 133.04 (not (visible antenna0 satellite4)))
        (at 121.00 (visible antenna1 satellite0))
        (at 201.04 (not (visible antenna1 satellite0)))
        (at 121.00 (visible antenna1 satellite3))
        (at 201.04 (not (visible antenna1 satellite3)))
        (at 121.00 (visible antenna1 satellite4))
        (at 201.04 (not (visible antenna1 satellite4)))
        (at 121.00 (visible antenna1 satellite2))
        (at 201.04 (not (visible antenna1 satellite2)))
        (at 210.00 (visible antenna0 satellite3))
        (at 290.04 (not (visible antenna0 satellite3)))
        (at 210.00 (visible antenna0 satellite1))
        (at 290.04 (not (visible antenna0 satellite1)))
        (at 210.00 (visible antenna0 satellite0))
        (at 290.04 (not (visible antenna0 satellite0)))
