...
(:durative-action land_1
 ...
 :effect    (and
                (at end (landed_last))
                (at end (not (idled_1)))
                (at start (occupied seg_rwtw2_0_10))
                (at start (not (not_occupied seg_rwtw2_0_10)))
                (at end (not (occupied seg_rwtw2_0_10)))
                (at end (not_occupied seg_rwtw2_0_10))
                (at start (occupied seg_rwtw1_0_10))
                (at start (not (not_occupied seg_rwtw1_0_10)))
                (at end (not (occupied seg_rwtw1_0_10)))
                (at end (not_occupied seg_rwtw1_0_10))
                (at start (occupied seg_rww_0_50))
                (at start (not (not_occupied seg_rww_0_50)))
                (at end (not (occupied seg_rww_0_50)))
                (at end (not_occupied seg_rww_0_50))
                ...
                (at end (not (occupied seg_rwe_0_50)))
                (at end (not_occupied seg_rwe_0_50))
                (at start (occupied seg_rwte1_0_10))
                (at start (not (not_occupied seg_rwte1_0_10)))
                (at end (not (occupied seg_rwte1_0_10)))
                (at end (not_occupied seg_rwte1_0_10))
                (at start (occupied seg_rwte2_0_10))
                (at start (not (not_occupied seg_rwte2_0_10)))
                (at end (not (occupied seg_rwte2_0_10)))
                (at end (not_occupied seg_rwte2_0_10))
            )
)
