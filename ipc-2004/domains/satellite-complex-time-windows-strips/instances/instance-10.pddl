...
(:init
        (= (image-utility planet10 infrared3 window0) 34.45)
        (= (image-utility planet10 infrared3 window1) 24.45)
        (= (image-utility planet10 infrared3 window2) 14.45)
        (= (image-utility planet5 image4 window0) 30.18)
        (= (image-utility planet5 image4 window1) 30.18)
        (= (image-utility planet5 image4 window2) 30.18)
        (= (image-utility planet9 infrared0 window0) 31.63)
        (= (image-utility planet9 infrared0 window1) 31.63)
        (= (image-utility planet9 infrared0 window2) 31.63)
        (= (image-utility star7 image4 window0) 25.37)
        (= (image-utility star7 image4 window1) 26.34)
        (= (image-utility star7 image4 window2) 39.25)
        (= (image-utility phenomenon8 image4 window0) 16.45)
        (= (image-utility phenomenon8 image4 window1) 16.45)
        (= (image-utility phenomenon8 image4 window2) 16.45)
        (= (image-utility star12 image4 window0) 31.40)
        (= (image-utility star12 image4 window1) 21.40)
        (= (image-utility star12 image4 window2) 11.40)
        (= (image-utility star6 infrared3 window0) 21.39)
        (= (image-utility star6 infrared3 window1) 21.39)
        (= (image-utility star6 infrared3 window2) 21.39)
        (= (image-utility phenomenon14 spectrograph1 window0) 35.71)
        (= (image-utility phenomenon14 spectrograph1 window1) 31.56)
        (= (image-utility phenomenon14 spectrograph1 window2) 16.67)
        (= (image-utility phenomenon13 image4 window0) 26.46)
        (= (image-utility phenomenon13 image4 window1) 14.83)
        (= (image-utility phenomenon13 image4 window2) 28.81)
        (= (image-utility star16 image2 window0) 33.10)
        (= (image-utility star16 image2 window1) 23.10)
        (= (image-utility star16 image2 window2) 13.10)
        (= (image-utility star15 spectrograph1 window0) 21.28)
        (= (image-utility star15 spectrograph1 window1) 37.03)
        (= (image-utility star15 spectrograph1 window2) 16.64)
	...
	(= (data-stored) 0)
        ...
        (= (send_time planet10 infrared3) 10.09)
        (= (send_time planet5 image4) 12.40)
        (= (send_time planet9 infrared0) 6.32)
        (= (send_time star7 image4) 17.45)
        (= (send_time phenomenon8 image4) 19.08)
        (= (send_time star12 image4) 15.23)
        (= (send_time star6 infrared3) 19.79)
        (= (send_time phenomenon14 spectrograph1) 7.24)
        (= (send_time phenomenon13 image4) 12.20)
        (= (send_time star16 image2) 17.62)
        (= (send_time star15 spectrograph1) 13.86)

        (at 56.00 (active window0 satellite1))
        (at 136.04 (not (active window0 satellite1)))
        (at 56.00 (active window0 satellite0))
        (at 136.04 (not (active window0 satellite0)))
        (at 56.00 (active window0 satellite4))
        (at 136.04 (not (active window0 satellite4)))
        (at 84.00 (active window1 satellite0))
        (at 164.04 (not (active window1 satellite0)))
        (at 84.00 (active window1 satellite4))
        (at 164.04 (not (active window1 satellite4)))
        (at 84.00 (active window1 satellite1))
        (at 164.04 (not (active window1 satellite1)))
        (at 216.00 (active window2 satellite3))
        (at 296.04 (not (active window2 satellite3)))
        (at 216.00 (active window2 satellite2))
        (at 296.04 (not (active window2 satellite2)))
        (at 216.00 (active window2 satellite0))
        (at 296.04 (not (active window2 satellite0)))
...
(:metric minimize (- (* 10 (total-time)) (* 1 (overall-image-utility))))
