...
(:init
        (= (image-utility phenomenon8 image2 window0) 31.00)
        (= (image-utility phenomenon8 image2 window1) 21.00)
        (= (image-utility phenomenon8 image2 window2) 11.00)
        (= (image-utility planet10 image4 window0) 28.35)
        (= (image-utility planet10 image4 window1) 22.46)
        (= (image-utility planet10 image4 window2) 33.54)
        (= (image-utility phenomenon13 spectrograph0 window0) 32.97)
        (= (image-utility phenomenon13 spectrograph0 window1) 32.97)
        (= (image-utility phenomenon13 spectrograph0 window2) 32.97)
        (= (image-utility star14 image4 window0) 27.57)
        (= (image-utility star14 image4 window1) 27.57)
        (= (image-utility star14 image4 window2) 27.57)
        (= (image-utility phenomenon7 infrared1 window0) 38.43)
        (= (image-utility phenomenon7 infrared1 window1) 28.43)
        (= (image-utility phenomenon7 infrared1 window2) 18.43)
        (= (image-utility phenomenon12 image3 window0) 15.32)
        (= (image-utility phenomenon12 image3 window1) 15.32)
        (= (image-utility phenomenon12 image3 window2) 15.32)
        (= (image-utility star9 image3 window0) 18.71)
        (= (image-utility star9 image3 window1) 18.71)
        (= (image-utility star9 image3 window2) 18.71)
        (= (image-utility planet11 spectrograph0 window0) 17.76)
        (= (image-utility planet11 spectrograph0 window1) 17.76)
        (= (image-utility planet11 spectrograph0 window2) 17.76)
        (= (image-utility planet5 image2 window0) 29.30)
        (= (image-utility planet5 image2 window1) 29.30)
        (= (image-utility planet5 image2 window2) 29.30)
        (= (image-utility phenomenon6 image3 window0) 34.20)
        (= (image-utility phenomenon6 image3 window1) 24.47)
        (= (image-utility phenomenon6 image3 window2) 14.01)
	...
	(= (data-stored) 0)
        ...
        (= (send_time phenomenon8 image2) 9.47)
        (= (send_time planet10 image4) 10.02)
        (= (send_time phenomenon13 spectrograph0) 16.97)
        (= (send_time star14 image4) 17.58)
        (= (send_time phenomenon7 infrared1) 13.10)
        (= (send_time phenomenon12 image3) 17.31)
        (= (send_time star9 image3) 19.24)
        (= (send_time planet11 spectrograph0) 12.02)
        (= (send_time planet5 image2) 10.59)
        (= (send_time phenomenon6 image3) 18.22)

        (at 60.00 (active window0 satellite2))
        (at 140.04 (not (active window0 satellite2)))
        (at 60.00 (active window0 satellite4))
        (at 140.04 (not (active window0 satellite4)))
        (at 86.00 (active window1 satellite1))
        (at 166.04 (not (active window1 satellite1)))
        (at 86.00 (active window1 satellite4))
        (at 166.04 (not (active window1 satellite4)))
        (at 86.00 (active window1 satellite3))
        (at 166.04 (not (active window1 satellite3)))
        (at 141.00 (active window2 satellite0))
        (at 221.04 (not (active window2 satellite0)))
        (at 141.00 (active window2 satellite1))
        (at 221.04 (not (active window2 satellite1)))
...
(:metric minimize (- (* 15 (total-time)) (* 10 (overall-image-utility))))
