...
(:init
        (= (image-utility star14 thermograph4 window0) 26.01)
        (= (image-utility star14 thermograph4 window1) 26.01)
        (= (image-utility star14 thermograph4 window2) 26.01)
        (= (image-utility star14 thermograph4 window3) 26.01)
        (= (image-utility star20 thermograph4 window0) 33.80)
        (= (image-utility star20 thermograph4 window1) 26.30)
        (= (image-utility star20 thermograph4 window2) 18.80)
        (= (image-utility star20 thermograph4 window3) 11.30)
        (= (image-utility phenomenon18 image1 window0) 18.05)
        (= (image-utility phenomenon18 image1 window1) 18.05)
        (= (image-utility phenomenon18 image1 window2) 18.05)
        (= (image-utility phenomenon18 image1 window3) 18.05)
        (= (image-utility phenomenon7 thermograph0 window0) 36.07)
        (= (image-utility phenomenon7 thermograph0 window1) 36.07)
        (= (image-utility phenomenon7 thermograph0 window2) 36.07)
        (= (image-utility phenomenon7 thermograph0 window3) 36.07)
        (= (image-utility star9 thermograph0 window0) 16.42)
        (= (image-utility star9 thermograph0 window1) 16.42)
        (= (image-utility star9 thermograph0 window2) 16.42)
        (= (image-utility star9 thermograph0 window3) 16.42)
        (= (image-utility planet23 image1 window0) 36.09)
        (= (image-utility planet23 image1 window1) 28.59)
        (= (image-utility planet23 image1 window2) 21.09)
        (= (image-utility planet23 image1 window3) 13.59)
        (= (image-utility phenomenon13 image1 window0) 10.59)
        (= (image-utility phenomenon13 image1 window1) 10.59)
        (= (image-utility phenomenon13 image1 window2) 10.59)
        (= (image-utility phenomenon13 image1 window3) 10.59)
        (= (image-utility star19 thermograph4 window0) 35.00)
        (= (image-utility star19 thermograph4 window1) 27.50)
        (= (image-utility star19 thermograph4 window2) 20.00)
        (= (image-utility star19 thermograph4 window3) 12.50)
        (= (image-utility phenomenon12 thermograph0 window0) 18.08)
        (= (image-utility phenomenon12 thermograph0 window1) 28.77)
        (= (image-utility phenomenon12 thermograph0 window2) 38.42)
        (= (image-utility phenomenon12 thermograph0 window3) 14.27)
        (= (image-utility star10 thermograph3 window0) 28.86)
        (= (image-utility star10 thermograph3 window1) 37.34)
        (= (image-utility star10 thermograph3 window2) 24.96)
        (= (image-utility star10 thermograph3 window3) 30.95)
        (= (image-utility phenomenon5 image1 window0) 31.25)
        (= (image-utility phenomenon5 image1 window1) 23.75)
        (= (image-utility phenomenon5 image1 window2) 16.25)
        (= (image-utility phenomenon5 image1 window3) 8.75)
        (= (image-utility star22 thermograph3 window0) 33.42)
        (= (image-utility star22 thermograph3 window1) 33.42)
        (= (image-utility star22 thermograph3 window2) 33.42)
        (= (image-utility star22 thermograph3 window3) 33.42)
        (= (image-utility planet15 image2 window0) 38.65)
        (= (image-utility planet15 image2 window1) 31.15)
        (= (image-utility planet15 image2 window2) 23.65)
        (= (image-utility planet15 image2 window3) 16.15)
        (= (image-utility planet21 thermograph0 window0) 13.58)
        (= (image-utility planet21 thermograph0 window1) 13.58)
        (= (image-utility planet21 thermograph0 window2) 13.58)
        (= (image-utility planet21 thermograph0 window3) 13.58)
        (= (image-utility planet17 image2 window0) 30.51)
        (= (image-utility planet17 image2 window1) 23.01)
        (= (image-utility planet17 image2 window2) 15.51)
        (= (image-utility planet17 image2 window3) 8.01)
        (= (image-utility planet8 image2 window0) 10.58)
        (= (image-utility planet8 image2 window1) 10.58)
        (= (image-utility planet8 image2 window2) 10.58)
        (= (image-utility planet8 image2 window3) 10.58)
	...
	(= (data-stored) 0)
        ...
        (= (send_time star14 thermograph4) 12.56)
        (= (send_time star20 thermograph4) 6.91)
        (= (send_time phenomenon18 image1) 8.72)
        (= (send_time phenomenon7 thermograph0) 16.92)
        (= (send_time star9 thermograph0) 12.99)
        (= (send_time planet23 image1) 6.89)
        (= (send_time phenomenon13 image1) 7.00)
        (= (send_time star19 thermograph4) 18.09)
        (= (send_time phenomenon12 thermograph0) 18.65)
        (= (send_time star10 thermograph3) 15.22)
        (= (send_time phenomenon5 image1) 16.54)
        (= (send_time star22 thermograph3) 19.44)
        (= (send_time planet15 image2) 6.04)
        (= (send_time planet21 thermograph0) 7.51)
        (= (send_time planet17 image2) 14.39)
        (= (send_time planet8 image2) 9.91)

        (at 56.00 (active window0 satellite1))
        (at 136.04 (not (active window0 satellite1)))
        (at 56.00 (active window0 satellite2))
        (at 136.04 (not (active window0 satellite2)))
        (at 56.00 (active window0 satellite3))
        (at 136.04 (not (active window0 satellite3)))
        (at 65.00 (active window1 satellite1))
        (at 145.04 (not (active window1 satellite1)))
        ...
        (at 65.00 (active window1 satellite3))
        (at 145.04 (not (active window1 satellite3)))
        (at 85.00 (active window2 satellite1))
        (at 165.04 (not (active window2 satellite1)))
        (at 85.00 (active window2 satellite2))
        (at 165.04 (not (active window2 satellite2)))
        (at 85.00 (active window2 satellite0))
        (at 165.04 (not (active window2 satellite0)))
        (at 168.00 (active window3 satellite1))
        (at 248.04 (not (active window3 satellite1)))
        (at 168.00 (active window3 satellite5))
        (at 248.04 (not (active window3 satellite5)))
        (at 168.00 (active window3 satellite4))
        (at 248.04 (not (active window3 satellite4)))
        (at 168.00 (active window3 satellite3))
        (at 248.04 (not (active window3 satellite3)))
...
(:metric minimize (- (* 64 (total-time)) (* 10 (overall-image-utility))))
