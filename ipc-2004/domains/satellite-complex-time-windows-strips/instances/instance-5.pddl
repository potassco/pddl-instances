...
(:init
        (= (image-utility phenomenon6 image2 window0) 11.25)
        (= (image-utility phenomenon6 image2 window1) 11.25)
        (= (image-utility star7 thermograph0 window0) 11.59)
        (= (image-utility star7 thermograph0 window1) 20.82)
        (= (image-utility star3 thermograph0 window0) 34.69)
        (= (image-utility star3 thermograph0 window1) 19.69)
        (= (image-utility phenomenon8 image2 window0) 21.58)
        (= (image-utility phenomenon8 image2 window1) 21.58)
        (= (image-utility phenomenon5 image2 window0) 34.67)
        (= (image-utility phenomenon5 image2 window1) 32.55)
        (= (image-utility planet9 spectrograph1 window0) 32.51)
        (= (image-utility planet9 spectrograph1 window1) 32.51)
	...
	(= (data-stored) 0)
        ...
        (= (send_time phenomenon6 image2) 6.99)
        (= (send_time star7 thermograph0) 15.51)
        (= (send_time star3 thermograph0) 14.57)
        (= (send_time phenomenon8 image2) 18.11)
        (= (send_time phenomenon5 image2) 19.19)
        (= (send_time planet9 spectrograph1) 10.65)

        (at 119.00 (active window0 satellite2))
        (at 199.04 (not (active window0 satellite2)))
        (at 119.00 (active window0 satellite0))
        (at 199.04 (not (active window0 satellite0)))
        (at 119.00 (active window0 satellite1))
        (at 199.04 (not (active window0 satellite1)))
        (at 150.00 (active window1 satellite2))
        (at 230.04 (not (active window1 satellite2)))
        (at 150.00 (active window1 satellite0))
        (at 230.04 (not (active window1 satellite0)))
...
(:metric minimize (- (* 27 (total-time)) (* 8 (overall-image-utility))))
