...
(:init
        (= (image-utility star3 infrared0 window0) 21.49)
        (= (image-utility phenomenon7 spectrograph2 window0) 13.66)
        (= (image-utility phenomenon5 spectrograph2 window0) 36.29)
        (= (image-utility star4 spectrograph2 window0) 28.60)
	...
	(= (data-stored) 0)
        ...
        (= (send_time star3 infrared0) 5.76)
        (= (send_time phenomenon7 spectrograph2) 10.76)
        (= (send_time phenomenon5 spectrograph2) 5.87)
        (= (send_time star4 spectrograph2) 18.38)

        (at 84.00 (active window0 satellite1))
        (at 164.04 (not (active window0 satellite1)))
        (at 84.00 (active window0 satellite0))
        (at 164.04 (not (active window0 satellite0)))
...
(:metric minimize (- (* 4 (total-time)) (* 7 (overall-image-utility))))
