...
(:init
        (= (image-utility planet19 thermograph2 window0) 37.31)
        (= (image-utility planet19 thermograph2 window1) 29.81)
        (= (image-utility planet19 thermograph2 window2) 22.31)
        (= (image-utility planet19 thermograph2 window3) 14.81)
        (= (image-utility star9 image1 window0) 38.77)
        (= (image-utility star9 image1 window1) 38.77)
        (= (image-utility star9 image1 window2) 38.77)
        (= (image-utility star9 image1 window3) 38.77)
        (= (image-utility star15 thermograph2 window0) 27.62)
        (= (image-utility star15 thermograph2 window1) 16.45)
        (= (image-utility star15 thermograph2 window2) 24.95)
        (= (image-utility star15 thermograph2 window3) 34.26)
        (= (image-utility phenomenon17 thermograph4 window0) 16.66)
        (= (image-utility phenomenon17 thermograph4 window1) 16.66)
        (= (image-utility phenomenon17 thermograph4 window2) 16.66)
        (= (image-utility phenomenon17 thermograph4 window3) 16.66)
        (= (image-utility phenomenon18 image1 window0) 26.59)
        (= (image-utility phenomenon18 image1 window1) 29.55)
        (= (image-utility phenomenon18 image1 window2) 24.67)
        (= (image-utility phenomenon18 image1 window3) 29.38)
        (= (image-utility star8 thermograph3 window0) 17.53)
        (= (image-utility star8 thermograph3 window1) 17.53)
        (= (image-utility star8 thermograph3 window2) 17.53)
        (= (image-utility star8 thermograph3 window3) 17.53)
        (= (image-utility phenomenon5 thermograph4 window0) 12.40)
        (= (image-utility phenomenon5 thermograph4 window1) 12.40)
        (= (image-utility phenomenon5 thermograph4 window2) 12.40)
        (= (image-utility phenomenon5 thermograph4 window3) 12.40)
        (= (image-utility planet7 image1 window0) 36.24)
        (= (image-utility planet7 image1 window1) 28.74)
        (= (image-utility planet7 image1 window2) 21.24)
        (= (image-utility planet7 image1 window3) 13.74)
        (= (image-utility star10 image1 window0) 39.74)
        (= (image-utility star10 image1 window1) 32.24)
        (= (image-utility star10 image1 window2) 24.74)
        (= (image-utility star10 image1 window3) 17.24)
        (= (image-utility phenomenon13 thermograph2 window0) 36.44)
        (= (image-utility phenomenon13 thermograph2 window1) 37.65)
        (= (image-utility phenomenon13 thermograph2 window2) 33.29)
        (= (image-utility phenomenon13 thermograph2 window3) 37.98)
        (= (image-utility phenomenon21 image1 window0) 35.83)
        (= (image-utility phenomenon21 image1 window1) 28.33)
        (= (image-utility phenomenon21 image1 window2) 20.83)
        (= (image-utility phenomenon21 image1 window3) 13.33)
        (= (image-utility planet20 thermograph4 window0) 24.21)
        (= (image-utility planet20 thermograph4 window1) 24.21)
        (= (image-utility planet20 thermograph4 window2) 24.21)
        (= (image-utility planet20 thermograph4 window3) 24.21)
        (= (image-utility star22 thermograph3 window0) 21.73)
        (= (image-utility star22 thermograph3 window1) 10.65)
        (= (image-utility star22 thermograph3 window2) 23.31)
        (= (image-utility star22 thermograph3 window3) 28.18)
	...
	(= (data-stored) 0)
        ...
        (= (send_time star9 image1) 16.43)
        (= (send_time star15 thermograph2) 11.12)
        (= (send_time phenomenon17 thermograph4) 16.39)
        (= (send_time phenomenon18 image1) 6.91)
        (= (send_time star8 thermograph3) 13.55)
        (= (send_time phenomenon5 thermograph4) 9.21)
        (= (send_time planet7 image1) 13.94)
        (= (send_time star10 image1) 10.11)
        (= (send_time phenomenon13 thermograph2) 12.81)
        (= (send_time phenomenon21 image1) 19.21)
        (= (send_time planet20 thermograph4) 17.18)
        (= (send_time star22 thermograph3) 5.77)

        (at 43.00 (active window0 satellite2))
        (at 123.04 (not (active window0 satellite2)))
        (at 43.00 (active window0 satellite0))
        (at 123.04 (not (active window0 satellite0)))
        (at 43.00 (active window0 satellite4))
        (at 123.04 (not (active window0 satellite4)))
        (at 60.00 (active window1 satellite0))
        (at 140.04 (not (active window1 satellite0)))
        (at 60.00 (active window1 satellite2))
        (at 140.04 (not (active window1 satellite2)))
        (at 60.00 (active window1 satellite4))
        (at 140.04 (not (active window1 satellite4)))
        (at 78.00 (active window2 satellite1))
        (at 158.04 (not (active window2 satellite1)))
        (at 78.00 (active window2 satellite2))
        (at 158.04 (not (active window2 satellite2)))
        (at 78.00 (active window2 satellite0))
        (at 158.04 (not (active window2 satellite0)))
        (at 78.00 (active window2 satellite3))
        (at 158.04 (not (active window2 satellite3)))
        (at 120.00 (active window3 satellite1))
        (at 200.04 (not (active window3 satellite1)))
...
(:metric minimize (- (* 54 (total-time)) (* 9 (overall-image-utility))))
