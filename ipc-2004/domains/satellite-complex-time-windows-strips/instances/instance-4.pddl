...
(:init
	...
	(= (data-stored) 0)
        ...
        (at 98.00 (active window0 satellite1))
        (at 178.04 (not (active window0 satellite1)))
        (at 98.00 (active window0 satellite0))
        (at 178.04 (not (active window0 satellite0)))
        (at 156.00 (active window1 satellite1))
        (at 236.04 (not (active window1 satellite1)))
