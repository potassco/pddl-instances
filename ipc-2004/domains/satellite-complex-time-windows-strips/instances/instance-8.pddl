...
(:init
        (= (image-utility star10 spectrograph3 window0) 30.60)
        (= (image-utility star10 spectrograph3 window1) 30.60)
        (= (image-utility star10 spectrograph3 window2) 30.60)
        (= (image-utility phenomenon13 thermograph1 window0) 12.06)
        (= (image-utility phenomenon13 thermograph1 window1) 14.74)
        (= (image-utility phenomenon13 thermograph1 window2) 38.58)
        (= (image-utility star6 thermograph1 window0) 10.37)
        (= (image-utility star6 thermograph1 window1) 17.30)
        (= (image-utility star6 thermograph1 window2) 28.81)
        (= (image-utility phenomenon8 image0 window0) 39.58)
        (= (image-utility phenomenon8 image0 window1) 29.58)
        (= (image-utility phenomenon8 image0 window2) 19.58)
        (= (image-utility phenomenon9 image0 window0) 35.17)
        (= (image-utility phenomenon9 image0 window1) 38.61)
        (= (image-utility phenomenon9 image0 window2) 31.17)
        (= (image-utility phenomenon14 thermograph2 window0) 37.89)
        (= (image-utility phenomenon14 thermograph2 window1) 27.89)
        (= (image-utility phenomenon14 thermograph2 window2) 17.89)
        (= (image-utility planet11 thermograph2 window0) 35.68)
        (= (image-utility planet11 thermograph2 window1) 25.68)
        (= (image-utility planet11 thermograph2 window2) 15.68)
        (= (image-utility phenomenon12 image0 window0) 30.04)
        (= (image-utility phenomenon12 image0 window1) 30.04)
        (= (image-utility phenomenon12 image0 window2) 30.04)
        (= (image-utility star7 spectrograph3 window0) 13.20)
        (= (image-utility star7 spectrograph3 window1) 28.83)
        (= (image-utility star7 spectrograph3 window2) 19.84)
        (= (image-utility phenomenon5 thermograph1 window0) 36.78)
        (= (image-utility phenomenon5 thermograph1 window1) 17.49)
        (= (image-utility phenomenon5 thermograph1 window2) 36.87)
	...
	(= (data-stored) 0)
        ...
        (= (send_time phenomenon13 thermograph1) 7.65)
        (= (send_time star6 thermograph1) 12.62)
        (= (send_time phenomenon8 image0) 17.72)
        (= (send_time phenomenon9 image0) 7.12)
        (= (send_time phenomenon14 thermograph2) 19.40)
        (= (send_time planet11 thermograph2) 18.68)
        (= (send_time phenomenon12 image0) 16.81)
        (= (send_time star7 spectrograph3) 8.98)
        (= (send_time phenomenon5 thermograph1) 18.82)

        (at 51.00 (active window0 satellite0))
        (at 131.04 (not (active window0 satellite0)))
        (at 51.00 (active window0 satellite3))
        (at 131.04 (not (active window0 satellite3)))
        (at 72.00 (active window1 satellite3))
        (at 152.04 (not (active window1 satellite3)))
        (at 72.00 (active window1 satellite2))
        (at 152.04 (not (active window1 satellite2)))
        (at 72.00 (active window1 satellite0))
        (at 152.04 (not (active window1 satellite0)))
        (at 92.00 (active window2 satellite0))
        (at 172.04 (not (active window2 satellite0)))
        (at 92.00 (active window2 satellite1))
        (at 172.04 (not (active window2 satellite1)))
...
(:metric minimize (- (* 5 (total-time)) (* 7 (overall-image-utility))))
