...
(:durative-action timedliteral5
 ...
 :effect
	...
	(at end (active window4 satellite8))
))
...
(:durative-action timedliteral20
 ...
 :effect
	...
	(at end (not (active window0 satellite8)))
...
(:durative-action timedliteral24
 ...
 :effect
	...
	(at end (active window21 satellite6))
...
(:durative-action timedliteral27
 ...
 :effect
	...
	(at end (not (active window4 satellite8)))
))
...
(:durative-action timedliteral44
 ...
 :effect
	...
	(at end (not (active window21 satellite6)))
