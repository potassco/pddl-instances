...
(:durative-action timedliteral11
 ...
 :effect
	...
	(at end (active window10 satellite9))
...
(:durative-action timedliteral15
 ...
 :effect
	...
	(at end (not (active window0 satellite5)))
))
...
(:durative-action timedliteral26
 ...
 :effect
	...
	(at end (not (active window10 satellite9)))
