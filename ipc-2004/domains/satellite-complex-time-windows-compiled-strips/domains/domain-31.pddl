...
(:durative-action timedliteral4
 ...
 :effect
	...
	(at end (active window3 satellite7))
...
(:durative-action timedliteral5
 ...
 :effect
	...
	(at end (active window4 satellite14))
	(at end (active window4 satellite9))
	(at end (active window4 satellite7))
))
...
(:durative-action timedliteral6
 ...
 :effect
	...
	(at end (active window5 satellite3))
...
(:durative-action timedliteral8
 ...
 :effect
	...
	(at end (active window7 satellite12))
))
...
(:durative-action timedliteral9
 ...
 :effect
	...
	(at end (active window8 satellite10))
))
...
(:durative-action timedliteral10
 ...
 :effect
	...
	(at end (active window9 satellite7))
	(at end (active window9 satellite14))
...
(:durative-action timedliteral11
 ...
 :effect
	...
	(at end (active window10 satellite12))
...
(:durative-action timedliteral12
 ...
 :effect
	...
	(at end (active window11 satellite13))
	(at end (active window11 satellite5))
	(at end (active window11 satellite10))
...
(:durative-action timedliteral13
 ...
 :effect
	...
	(at end (active window12 satellite6))
))
...
(:durative-action timedliteral15
 ...
 :effect
	...
	(at end (active window14 satellite10))
))
...
(:durative-action timedliteral16
 ...
 :effect
	...
	(at end (active window15 satellite6))
))
...
(:durative-action timedliteral17
 ...
 :effect
	...
	(at end (active window16 satellite7))
	(at end (active window16 satellite12))
...
(:durative-action timedliteral18
 ...
 :effect
	...
	(at end (active window17 satellite10))
))
...
(:durative-action timedliteral19
 ...
 :effect
	...
	(at end (active window18 satellite13))
...
(:durative-action timedliteral22
 ...
 :effect
	...
	(at end (active window21 satellite14))
	(at end (active window21 satellite10))
	(at end (active window21 satellite9))
))
...
(:durative-action timedliteral24
 ...
 :effect
	...
	(at end (active window23 satellite6))
...
(:durative-action timedliteral26
 ...
 :effect
	...
	(at end (active window24 satellite5))
...
(:durative-action timedliteral27
 ...
 :effect
	...
	(at end (active window25 satellite13))
	(at end (active window25 satellite14))
...
(:durative-action timedliteral28
 ...
 :effect
	...
	(at end (active window26 satellite8))
	(at end (active window26 satellite3))
	(at end (active window26 satellite12))
))
...
(:durative-action timedliteral31
 ...
 :effect
	...
	(at end (active window28 satellite13))
...
(:durative-action timedliteral32
 ...
 :effect
	...
	(at end (active window29 satellite10))
...
(:durative-action timedliteral33
 ...
 :effect
	...
	(at end (active window30 satellite8))
	(at end (active window30 satellite3))
	(at end (active window30 satellite12))
	(at end (active window30 satellite2))
))
...
(:durative-action timedliteral34
 ...
 :effect
	...
	(at end (active window31 satellite6))
...
(:durative-action timedliteral36
 ...
 :effect
	...
	(at end (not (active window3 satellite7)))
...
(:durative-action timedliteral37
 ...
 :effect
	...
	(at end (not (active window4 satellite14)))
	(at end (not (active window4 satellite9)))
	(at end (not (active window4 satellite7)))
))
...
(:durative-action timedliteral38
 ...
 :effect
	...
	(at end (not (active window5 satellite3)))
...
(:durative-action timedliteral40
 ...
 :effect
	...
	(at end (not (active window7 satellite12)))
))
...
(:durative-action timedliteral41
 ...
 :effect
	...
	(at end (not (active window8 satellite10)))
))
...
(:durative-action timedliteral42
 ...
 :effect
	...
	(at end (not (active window9 satellite7)))
	(at end (not (active window9 satellite14)))
...
(:durative-action timedliteral43
 ...
 :effect
	...
	(at end (not (active window10 satellite12)))
...
(:durative-action timedliteral44
 ...
 :effect
	...
	(at end (not (active window11 satellite13)))
	(at end (not (active window11 satellite5)))
	(at end (not (active window11 satellite10)))
...
(:durative-action timedliteral45
 ...
 :effect
	...
	(at end (not (active window12 satellite6)))
))
...
(:durative-action timedliteral47
 ...
 :effect
	...
	(at end (not (active window14 satellite10)))
))
...
(:durative-action timedliteral49
 ...
 :effect
	...
	(at end (not (active window15 satellite6)))
))
...
(:durative-action timedliteral50
 ...
 :effect
	...
	(at end (not (active window16 satellite7)))
	(at end (not (active window16 satellite12)))
...
(:durative-action timedliteral51
 ...
 :effect
	...
	(at end (not (active window17 satellite10)))
))
...
(:durative-action timedliteral52
 ...
 :effect
	...
	(at end (not (active window18 satellite13)))
...
(:durative-action timedliteral55
 ...
 :effect
	...
	(at end (not (active window21 satellite14)))
	(at end (not (active window21 satellite10)))
	(at end (not (active window21 satellite9)))
))
...
(:durative-action timedliteral57
 ...
 :effect
	...
	(at end (not (active window23 satellite6)))
...
(:durative-action timedliteral58
 ...
 :effect
	...
	(at end (not (active window24 satellite5)))
...
(:durative-action timedliteral59
 ...
 :effect
	...
	(at end (not (active window25 satellite13)))
	(at end (not (active window25 satellite14)))
...
(:durative-action timedliteral60
 ...
 :effect
	...
	(at end (not (active window26 satellite8)))
	(at end (not (active window26 satellite3)))
	(at end (not (active window26 satellite12)))
))
...
(:durative-action timedliteral62
 ...
 :effect
	...
	(at end (not (active window28 satellite13)))
...
(:durative-action timedliteral63
 ...
 :effect
	...
	(at end (not (active window29 satellite10)))
...
(:durative-action timedliteral64
 ...
 :effect
	...
	(at end (not (active window30 satellite8)))
	(at end (not (active window30 satellite3)))
	(at end (not (active window30 satellite12)))
	(at end (not (active window30 satellite2)))
))
...
(:durative-action timedliteral65
 ...
 :effect
	...
	(at end (not (active window31 satellite6)))
...
(:durative-action timedliteral66
 :parameters ()
 :duration (= ?duration 40.00)
 :condition
	(and (over all (TLrunning)) (over all (TL65)))
 :effect
	(and (at end (TLend)) (at end (not (TL65)))
